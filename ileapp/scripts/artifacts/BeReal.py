...
from ileapp.scripts.ilapfuncs import get_file_path, get_sqlite_db_records, get_plist_content, get_plist_file_content, convert_unix_ts_to_utc, \
        ...
        try:
            ...
            for i in range(0, len(contacts)):
                ...
                if bool(photo_b64):
                    ...
                    photo = check_in_embedded_media(file_found, photo_raw)
                else:
                    photo = ''
                # organization name
