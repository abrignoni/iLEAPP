...
class FileSeekerItunes(FileSeekerBase):
    def __init__(self, directory, data_folder, passcode=None):
        FileSeekerBase.__init__(self)
        self.directory = directory
        self._all_files = {}
        self._all_file_meta = {}
