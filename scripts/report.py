...
def get_svg_icons():
    root_dir = Path.cwd() / "assets/tabler_icons"
    
    # On utilise rglob pour trouver tous les fichiers
    # On filtre les chemins qui contiennent '__pycache__'
    return {
        file.stem 
        for file in root_dir.rglob("*.svg") 
