__artifacts_v2__ = {
	'Ph097_1iOS17RefforAssetAnalysisPhDaPsql': {
		...
		'category': 'Photos.sqlite-Z-TableJoinReference-iOS17-PhotoData-Psql',
		'notes': '',
	...
	'Ph097_2iOS17RefforAssetAnalysisSyndPL': {
		...
		'category': 'Photos.sqlite-Z-TableJoinReference-iOS17-SyndicationPL-Psql',
		'notes': '',
...
@artifact_processor
def Ph097_1iOS17RefforAssetAnalysisPhDaPsql(files_found, report_folder, seeker, wrap_text, timezone_offset):
...
@artifact_processor
def Ph097_2iOS17RefforAssetAnalysisSyndPL(files_found, report_folder, seeker, wrap_text, timezone_offset):
	for source_path in files_found:
		source_path = str(source_path)
