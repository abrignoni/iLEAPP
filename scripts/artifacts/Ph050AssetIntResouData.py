...
__artifacts_v2__ = {
	'Ph050_1AssetIntResouPhDaPsql': {
		...
		'category': 'Photos.sqlite-InternalResourceData-PhotoData-Psql',
		'notes': '',
  ...
  'sample_data': {
	...
	'Ph050_2AssetIntResouSyndPL': {
		...
		'category': 'Photos.sqlite-InternalResourceData-SyndicationPL-Psql',
		'notes': '',
		'paths': ('*/PhotoData/Photos.sqlite*',),
		"output_types": ["standard", "tsv", "none"],
		"artifact_icon": "database",
  'sample_data': {
	...
	'Ph050_3AssetIntResouGenPlayPsql': {
        ...
        'category': 'Photos.sqlite-InternalResourceData-GenPlaygrndPL-Psql',
        'notes': '',
...
@artifact_processor
def Ph050_1AssetIntResouPhDaPsql(files_found, report_folder, seeker, wrap_text, timezone_offset):
    ...
    if (version.parse(iosversion) >= version.parse("14")) & (version.parse(iosversion) < version.parse("15")):
        ...
        query = '''
		SELECT
		DateTime(zAsset.ZDATECREATED + 978307200, 'UNIXEPOCH') AS 'zAsset-Date Created-4QueryStart- datetime',
		zAsset.Z_PK AS 'zAsset-zPK',
		zAddAssetAttr.Z_PK AS 'zAddAssetAttr-zPK',
		zAsset.ZUUID AS 'zAsset-UUID = store.cloudphotodb',
		zAddAssetAttr.ZORIGINALSTABLEHASH AS 'zAddAssetAttr-Original Stable Hash',
		...
		DateTime(zAsset.ZANALYSISSTATEMODIFICATIONDATE + 978307200, 'UNIXEPOCH') AS 'zAsset-Analysis State Modification Date- datetime',
		zAddAssetAttr.ZPENDINGVIEWCOUNT AS 'zAddAssetAttr- Pending View Count',
		zAddAssetAttr.ZVIEWCOUNT AS 'zAddAssetAttr- View Count',
		zAddAssetAttr.ZPENDINGPLAYCOUNT AS 'zAddAssetAttr- Pending Play Count',
		zAddAssetAttr.ZPLAYCOUNT AS 'zAddAssetAttr- Play Count',
        ...
        data_headers = (('zAsset-Date Created-4QueryStart- datetime-0',  'datetime'),
                        'zAsset-zPK-1',
                        'zAddAssetAttr-zPK-2',
                        'zAsset-UUID = store.cloudphotodb-3',
                        'zAddAssetAttr-Original Stable Hash-4',
                        'zIntResou-Fingerprint-5',
                        'zAddAssetAttr.Adjusted Stable Hash-6',
                        'zCompSyncAttr-Cloud_Compute_State_Adjustment_Fingerprint-7',
                        'zIntResou-Stable Hash-8',
                        'zIntResou-Local Availability-4QueryStart-9',
                        'zIntResou-Remote Availability-4QueryStart-10',
                        'zIntResou-Resource Type-4QueryStart-11',
                        'zIntResou-Datastore Sub-Type-4QueryStart-12',
                        ...
                        'zExtAttr-Focal Length in 35MM-26',
                        'zExtAttr-Digital Zoom Ratio-27',
                        'zExtAttr-Generative_AI_Type-28',
                        'zExtAttr-Credit-29',
                        'zAsset-Derived Camera Capture Device-30',
                        'zAddAssetAttr-Camera Captured Device-31',
                        'zAsset-Capture_Session_Identifier-32',
                        'zAddAssetAttr-Imported by-33',
                        'zCldMast-Imported By-34',
                        'zAddAssetAttr.Imported by Bundle Identifier-35',
                        'zAddAssetAttr-Imported By Display Name-36',
                        ...
                        'zAsset-Active Library Scope Participation State-46',
                        'zAsset-Library Scope Share State- StillTesting-47',
                        ('zAsset-Added Date- datetime-48',  'datetime'),
                        ('zAsset- SortToken -CameraRoll- datetime-49',  'datetime'),
                        'zAddAssetAttr-Date Created Source-50',
                        ('zAsset-Date Created- datetime-51',  'datetime'),
                        ('zCldMast-Creation Date- datetime-52',  'datetime'),
                        ('zIntResou-CldMst Date Created- datetime-53',  'datetime'),
                        'zAddAssetAttr-Time Zone Name-54',
                        'zAddAssetAttr-Time Zone Offset-55',
                        'zAddAssetAttr-Inferred Time Zone Offset-56',
                        'zAddAssetAttr-EXIF-String-57',
                        ('zAsset-Modification Date- datetime-58',  'datetime'),
                        ('zAsset-Last Shared Date- datetime-59',  'datetime'),
                        'zCldMast-Cloud Local State-60',
                        ('zCldMast-Import Date- datetime-61',  'datetime'),
                        ('zAddAssetAttr-Last Upload Attempt Date-SWY_Files- datetime-62',  'datetime'),
                        'zAddAssetAttr-Import Session ID-63',
                        ('zAddAssetAttr-Alt Import Image Date- datetime-64',  'datetime'),
                        'zCldMast-Import Session ID- AirDrop-StillTesting-65',
                        ('zAsset-Cloud Batch Publish Date- datetime-66',  'datetime'),
                        ('zAsset-Cloud Server Publish Date- datetime-67',  'datetime'),
                        'zAsset-Cloud Download Requests-68',
                        'zAsset-Cloud Batch ID-69',
                        'zAddAssetAttr-Upload Attempts-70',
                        'zAsset-Latitude-71',
                        ...
                        'zAddAssetAttr-Original Orientation-92',
                        'zAsset-Kind-93',
                        'zAsset-Is_Detected_Screenshot-94',
                        'zAsset-Kind-Sub-Type-95',
                        'zAddAssetAttr-Cloud Kind Sub Type-96',
                        'zAsset-Playback Style-97',
                        'zAsset-Playback Variation-98',
                        'zAddAssetAttr-View_Presentation-99',
                        'zAsset-Video Duration-100',
                        'zExtAttr-Duration-101',
                        'zAsset-Video CP Duration-102',
                        'zAddAssetAttr-Video CP Duration Time Scale-103',
                        ...
                        'zAddAssetAttr-Video CP Display Time Scale-106',
                        'zIntResou-Datastore Class ID-107',
                        'zIntResou-Local Availability-108',
                        'zIntResou-Local Availability Target-109',
                        'zIntResou-Cloud Local State-110',
                        'zIntResou-Remote Availability-111',
                        'zIntResou-Remote Availability Target-112',
                        'zIntResou-Side Car Index-113',
                        'zIntResou- File ID-114',
                        'zIntResou-Version-115',
                        'zAddAssetAttr- Original-File-Size-116',
                        'zIntResou-Resource Type-117',
                        'zIntResou-Datastore Sub-Type-118',
                        'zIntResou-Cloud Source Type-119',
                        'zIntResou-Data Length-120',
                        'zIntResou-Recipe ID-121',
                        ('zIntResou-Cloud Last Prefetch Date- datetime-122',  'datetime'),
                        'zIntResou-Cloud Prefetch Count-123',
                        ('zIntResou- Cloud-Last-OnDemand Download-Date- datetime-124',  'datetime'),
                        'zIntResou-UniformTypeID_UTI_Conformance_Hint-125',
                        'zIntResou-Compact-UTI-126',
                        'zAsset-Uniform Type ID-127',
                        'zAsset-Original Color Space-128',
                        'zCldMast-Uniform_Type_ID-129',
                        'zCldMast-Full Size JPEG Source-130',
                        'zAsset-HDR Gain-131',
                        'zAsset-zHDR_Type-132',
                        'zExtAttr-Codec-133',
                        'zIntResou-Codec Four Char Code Name-134',
                        'zCldMast-Codec Name-135',
                        'zCldMast-Video Frame Rate-136',
                        'zCldMast-Placeholder State-137',
                        'zAsset-Depth_Type-138',
                        'zAsset-Avalanche UUID-139',
                        'zAsset-Avalanche_Kind-140',
                        'zAsset-Avalanche_Pick_Type-BurstAsset-141',
                        'zAddAssetAttr-Cloud_Avalanche_Pick_Type-BurstAsset-142',
                        'zAddAssetAttr-Cloud Recovery State-143',
                        'zAddAssetAttr-Cloud State Recovery Attempts Count-144',
                        'zAsset-Deferred Processing Needed-145',
                        'zAsset-Video Deferred Processing Needed-146',
                        'zAddAssetAttr-Deferred Photo Identifier-147',
                        'zAddAssetAttr-Deferred Processing Candidate Options-148',
                        'zAsset-Adjustments_State-149',
                        ('zAsset-Adjustment Timestamp- datetime-150',  'datetime'),
                        ('zCompSyncAttr-Cloud_Compute_State_Last_Updated_Date- datetime-151',  'datetime'),
                        'zAddAssetAttr-Editor Bundle ID-152',
                        'zAddAssetAttr-Montage-153',
                        'zCompSyncAttr-Local_Analysis_Major_Version-154',
                        'zAsset-Favorite-155',
                        'zAsset-Hidden-156',
                        'zAsset-Trashed State-LocalAssetRecentlyDeleted-157',
                        ('zAsset-Trashed Date- datetime-158',  'datetime'),
                        'zAsset-Trashed by Participant= zSharePartic_zPK-159',
                        'zAsset-Delete-Reason-160',
                        'zIntResou-Trash State-161',
                        ('zIntResou-Trashed Date- datetime-162',  'datetime'),
                        'zAsset-Cloud Delete State-163',
                        'zIntResou-Cloud Delete State-164',
                        'zAddAssetAttr-PTP Trashed State-165',
                        'zIntResou-PTP Trashed State-166',
                        'zIntResou-Cloud Delete Asset UUID With Resource Type-167',
                        ('zMedAnlyAstAttr-Media Analysis Timestamp- datetime-168',  'datetime'),
                        ('zAsset-Analysis State Modification Date- datetime-169',  'datetime'),
                        'zAddAssetAttr- Pending View Count-170',
                        'zAddAssetAttr- View Count-171',
                        'zAddAssetAttr- Pending Play Count-172',
                        'zAddAssetAttr- Play Count-173',
                        'zAddAssetAttr- Pending Share Count-174',
                        'zAddAssetAttr- Share Count-175',
                        'zAddAssetAttr-Allowed for Analysis-176',
                        'zAddAssetAttr-Scene Analysis Version-177',
                        'zAddAssetAttr-Scene Analysis is From Preview-178',
                        ('zAddAssetAttr-Scene Analysis Timestamp- datetime-179',  'datetime'),
                        'zAsset-Duplication Asset Visibility State-180',
                        'zAddAssetAttr-Destination Asset Copy State-181',
                        'zAddAssetAttr-Duplicate Detector Perceptual Processing State-182',
                        'zAddAssetAttr-Source Asset for Duplication Scope ID-183',
                        'zCldMast-Source Master For Duplication Scope ID-184',
                        'zAddAssetAttr-Source Asset For Duplication ID-185',
                        'zCldMast-Source Master for Duplication ID-186',
                        'zAddAssetAttr-Variation Suggestions States-187',
                        'zAsset-High Frame Rate State-188',
                        'zAsset-Video Key Frame Time Scale-189',
                        'zAsset-Video Key Frame Value-190',
                        'zAsset-Current_Sleet_Cast-191',
                        'zAddAssetAttr.Sleet_Is_Reversible-192',
                        'zExtAttr-Sleet_Rendering_Version-193',
                        'zExtAttr-Sleet_Intensity-194',
                        'zExtAttr-Sleet_Tone_Bias-195',
                        'zExtAttr-Sleet_Color_Bias-196',
                        'zExtAttr-Sleet_Cast-197',
                        'zExtAttr-ISO-198',
                        'zExtAttr-Metering Mode-199',
                        'zExtAttr-Sample Rate-200',
                        'zExtAttr-Track Format-201',
                        'zExtAttr-White Balance-202',
                        'zExtAttr-Aperture-203',
                        'zExtAttr-BitRate-204',
                        'zExtAttr-Exposure Bias-205',
                        'zExtAttr-Frames Per Second-206',
                        'zExtAttr-Shutter Speed-207',
                        'zExtAttr-Slush Scene Bias-208',
                        'zExtAttr-Slush Version-209',
                        'zExtAttr-Slush Preset-210',
                        'zExtAttr-Slush Warm Bias-211',
                        'zAsset-Height-212',
                        'zAddAssetAttr-Original Height-213',
                        'zIntResou-UnOriented Height-214',
                        'zAsset-Width-215',
                        'zAddAssetAttr-Original Width-216',
                        'zIntResou-UnOriented Width-217',
                        'zAsset-Thumbnail Index-218',
                        'zAddAssetAttr-Embedded Thumbnail Height-219',
                        'zAddAssetAttr-Embedded Thumbnail Length-220',
                        'zAddAssetAttr-Embedded Thumbnail Offset-221',
                        'zAddAssetAttr-Embedded Thumbnail Width-222',
                        'zAsset-Packed Acceptable Crop Rect-223',
                        'zAsset-Packed Badge Attributes-224',
                        'zAsset-Packed Preferred Crop Rect-225',
                        'zAsset-Curation Score-226',
                        'zAsset-Camera Processing Adjustment State-227',
                        'zAsset-Depth Type-228',
                        'zAsset-Is Magic Carpet-Quicktime_MOV-file-229',
                        'zAddAssetAttr-Orig Resource Choice-230',
                        'zAsset-Spatial Type-231',
                        'zAddAssetAttr-Spatial Over Capture Group ID-232',
                        'zAddAssetAttr-Place Annotation Data-233',
                        'zAddAssetAttr-Distance Identity-HEX-234',
                        'zAddAssetAttr-Edited IPTC Attributes-235',
                        'zAddAssetAttr-Title-Comments via Cloud Website-236',
                        'zAddAssetAttr-Accessibility Description-237',
                        'zAddAssetAttr-Photo Stream Tag ID-238',
                        'zAddAssetAttr-Share Type-239',
                        'zAddAssetAttr-Library Scope Asset Contributors To Update-240',
                        'zAsset-Overall Aesthetic Score-241',
                        'zMedAnlyAstAttr-Media_Analysis Image_Version-242',
                        'zMedAnlyAstAttr-Image_Caption_Version-243',
                        'zMedAnlyAstAttr-Video_Caption_Version-244',
                        'zMedAnlyAstAttr-VA_Location_Analysis_Version-245',
                        'zAsset-zENT-246',
                        'zAsset-zOPT-247',
                        'zAsset-Master= zCldMast-zPK-248',
                        'zAsset-Extended Attributes= zExtAttr-zPK-249',
                        'zAsset-Import Session Key-250',
                        'zAsset-Photo Analysis Attributes Key-251',
                        'zAsset-FOK-Cloud Feed Asset Entry Key-252',
                        'zAsset-Computed Attributes Asset Key-253',
                        'zAsset-Promotion Score-254',
                        'zAsset-Iconic Score-255',
                        'zAsset-Media Analysis Attributes Key-256',
                        'zAsset-Media Group UUID-257',
                        'zAsset-Cloud_Asset_GUID = store.cloudphotodb-258',
                        'zAsset.Cloud Collection GUID-259',
                        'zAddAssetAttr-zENT-260',
                        'ZAddAssetAttr-zOPT-261',
                        'zAddAssetAttr-zAsset= zAsset_zPK-262',
                        'zAddAssetAttr-UnmanAdjust Key= zUnmAdj.zPK-263',
                        'zAddAssetAttr-MediaMetadata= AAAzCldMastMedData-zPK-264',
                        'zAddAssetAttr-Public Global UUID-265',
                        'zAddAssetAttr-Original Assets UUID-266',
                        'zAddAssetAttr-Originating Asset Identifier-267',
                        'zCldMast-zPK= zAsset-Master-268',
                        'zCldMast-zENT-269',
                        'zCldMast-zOPT-270',
                        'zCldMast-Moment Share Key= zShare-zPK-271',
                        'zCldMast-Media Metadata Key= zCldMastMedData.zPK-272',
                        'zCldMast-Cloud_Master_GUID = store.cloudphotodb-273',
                        'zCldMast-Originating Asset ID-274',
                        'CMzCldMastMedData-zPK= zAddAssetAttr&zCldMast-MediaMetaData Key-275',
                        'CMzCldMastMedData-zENT-276',
                        'CMzCldMastMedData-CldMast= zCldMast-zPK-277',
                        'AAAzCldMastMedData-zPK= zAddAssetAttr&zCldMast-MediaMetaData-278',
                        'AAAzCldMastMedData-zENT-279',
                        'AAAzCldMastMedData-CldMast key-280',
                        'AAAzCldMastMedData-AddAssetAttr= AddAssetAttr-zPK-281',
                        'zAsset-Compute_Sync_Attributes= zCompSyncAttr-zPK-282',
                        'zCompSyncAttr-zPK= zAsset-zCompSyncAttr-283',
                        'zCompSyncAttr-zAsset= zAsset-zPK-284',
                        'zCompSyncAttr-zENT-285',
                        'zCompSyncAttr-zOPT-286',
                        'zCompSyncAttr-Local_Analysis_Stage-287',
                        'zCompSyncAttr-Cloud_Compute_State_Version-288',
                        'zExtAttr-zPK= zAsset-zExtendedAttributes-289',
                        'zExtAttr-zENT-290',
                        'zExtAttr-zOPT-291',
                        'zExtAttr-Asset Key-292',
                        'zIntResou-zPK-293',
                        'zIntResou-zENT-294',
                        'zIntResou-zOPT-295',
                        'zIntResou-Asset= zAsset_zPK-296',
                        'zMedAnlyAstAttr-zPK= zAddAssetAttr-Media Metadata-297',
                        'zMedAnlyAstAttr-zEnt-298',
...
@artifact_processor
def Ph050_2AssetIntResouSyndPL(files_found, report_folder, seeker, wrap_text, timezone_offset):
	for source_path in files_found:
		source_path = str(source_path)
	...
	if (version.parse(iosversion) >= version.parse("14")) & (version.parse(iosversion) < version.parse("15")):
		...
		zIntResou.ZFINGERPRINT AS 'zIntResou-Fingerprint-iOS18',
...
@artifact_processor
def Ph050_3AssetIntResouGenPlayPsql(files_found, report_folder, seeker, wrap_text, timezone_offset):
	for source_path in files_found:
		source_path = str(source_path)
	...
	if (version.parse(iosversion) <= version.parse("13.7")) or (version.parse(iosversion) >= version.parse("27")):
		...
		return (), [], source_path
	if (version.parse(iosversion) >= version.parse("18")) & (version.parse(iosversion) < version.parse("26")):
		source_path = get_file_path(files_found, "Photos.sqlite")
		if source_path is None or not os.path.exists(source_path):
			logfunc(f"Photos.sqlite not found for iOS version {iosversion}")
			return (), [], source_path
