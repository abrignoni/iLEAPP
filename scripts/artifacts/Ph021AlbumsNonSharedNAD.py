...
__artifacts_v2__ = {
    'Ph021NonSharedAlbumRecordswithNADPhDaPsql': {
        ...
        'category': 'Photos.sqlite-Albums-Only-NonShared-PhotoData-Psql',
        'notes': '',
...
@artifact_processor
def Ph021NonSharedAlbumRecordswithNADPhDaPsql(files_found, report_folder, seeker, wrap_text, timezone_offset):
