...
def get_kikUsersgroups(files_found, report_folder, seeker):
    ...
    Order By Z_9MEMBERS.Z_9MEMBERSINVERSE, Z_9ADMINSINVERSE.Z_9ADMINSINVERSE DESC /*sorted by Group ID, then Admin status*/
    ''')
    ...
    if usageentries > 0:
        ...
        report.add_script()
        data_headers = ('User ID','Display Name','Username','Profile Pic URL','Member Group ID','Administrator Group ID','Group Tag','Group Name','Group ID','Group Pic URL','Blob','Additional Information')     
