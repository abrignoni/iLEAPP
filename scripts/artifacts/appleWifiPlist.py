        ...
        with open(file_found, 'rb') as f:
            ...
            if 'List of known networks' in deserialized:
                for known_network in deserialized['List of known networks']:
                    ...
                    data_list.append([last_updated, last_auto_joined, last_joined, '', '', wnpmd, '', '', '', '', prev_joined, ssid, bssid, file_found])
            ...
            if 'com.apple.wifi.known-networks.plist' in file_found:
                for network_key, known_network in deserialized.items():
                    ...
                    data_list.append([last_updated, '', '', system_joined, user_joined, wnpmd, 
                                      last_discovered, added_at, whitelisted_probe_date, captive_web_sheet_login_date, 
                                      prev_joined, ssid, bssid, file_found])

    data_headers = (('Last Updated', 'datetime'), ('Last Auto Joined', 'datetime'), 
                    ...
                    ('Captive Web Sheet Login Date', 'datetime'), ('Previous Joined', 'datetime'), 'SSID', 'BSSID', 'Source File')
            ...
            if 'com.apple.wifi.known-networks.plist' in file_found:
                for network_key, known_network in deserialized.items():
                    ...
                    for bss in bss_list:
                        ...
                        data_list.append([
                            last_associated_at, location_timestamp, ssid, bssid, channel_flags, channel,
                            location_accuracy, location_latitude, location_longitude,
                            file_found
                        ])
            ...
            if 'List of known networks' in deserialized:
                for known_network in deserialized['List of known networks']:
                    ...
                    for bss in bss_list:
                        ...
                        data_list.append([
                            '', '', ssid, bssid, channel_flags, channel,
                            last_roamed, '', '',
                            file_found
                        ])

    data_headers = (
        ('Last Associated/Roamed At', 'datetime'), ('Location Timestamp', 'datetime'), 'SSID', 'BSSID', 'Channel Flags', 'Channel',
