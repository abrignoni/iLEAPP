__artifacts_v2__ = {
    "housepartyMessages": {
        ...
        "notes": "Read from class_RealmNote in Documents/houseparty.rocky.realm with the vendored "
                 ...
                 "millisecond. A facemail row is one whose facemail link resolves to "
                 "class_RealmFacemail, whose thumbnail column holds a base64 PNG that is "
                 "rendered in Facemail Thumbnail, and whose mediaID names the video. The video "
    ...
    "housepartyRooms": {
        ...
        "notes": "Read from class_RealmRoom in the app's Realm store, with the session joined from "
                 ...
                 "rtcp.on.epicgames.com and the third a host under ms.thehousepartyapp.com, and "
                 "on the iOS 14 image all four named ms.thehousepartyapp.com hosts. The "
                 "session's latestTicketString is not reported.",
        "paths": ('*/Documents/houseparty.rocky.realm',),
        "output_types": "standard",
        "artifact_icon": "video",
        "sample_data": {
    ...
    "housepartyAccount": {
        ...
        "notes": "Read from class_RealmUser in the app's Realm store, with the public profile "
                 ...
                 "Session Invalidated is blank where class_RealmToken holds the Unix epoch, as "
