__artifacts_v2__ = {
    "reminders": {
        ...
        "notes": "Two store generations are read. iOS 16 and later test images keep reminders in a "
                 ...
                 "iOS 13, 14 and 15 test images). On the iOS 17 and later test images the store "
                 "sits in the Reminders app-group container rather than "
                 "Library/Reminders/Container_v1. On the "
