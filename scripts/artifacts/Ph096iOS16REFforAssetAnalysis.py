...
__artifacts_v2__ = {
	'Ph096_1iOS16RefforAssetAnalysisPhDaPsql': {
		...
		'category': 'Photos.sqlite-Z-TableJoinReference-iOS16-PhotoData-Psql',
		'notes': '',
  ...
  'sample_data': {
      ...
      'abe_ios16': 'iOS 16.5 | 10818 rows',
      'felix23_ios16': 'iOS 16.5 | 158 rows',
	...
	'Ph096_2iOS16RefforAssetAnalysisSyndPL': {
		...
		'category': 'Photos.sqlite-Z-TableJoinReference-iOS16-SyndicationPL-Psql',
		'notes': '',
...
@artifact_processor
def Ph096_1iOS16RefforAssetAnalysisPhDaPsql(files_found, report_folder, seeker, wrap_text, timezone_offset):
...
@artifact_processor
def Ph096_2iOS16RefforAssetAnalysisSyndPL(files_found, report_folder, seeker, wrap_text, timezone_offset):
	for source_path in files_found:
		source_path = str(source_path)
