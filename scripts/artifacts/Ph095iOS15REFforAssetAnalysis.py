...
__artifacts_v2__ = {
	'Ph095_1iOS15RefforAssetAnalysisPhDaPsql': {
		'name': 'Ph095.1-iOS15_Ref_for_Asset_Analysis-PhDaPsql',
		...
		'category': 'Photos.sqlite-Z-TableJoinReference-iOS15-PhotoData-Psql',
		'notes': '',
  ...
  'sample_data': {
	...
	'Ph095_2iOS15RefforAssetAnalysisSyndPL': {
		'name': 'Ph095.2-iOS15_Ref_for_Asset_Analysis-SyndPL',
		...
		'category': 'Photos.sqlite-Z-TableJoinReference-iOS15-SyndicationPL-Psql',
		'notes': '',
...
@artifact_processor
def Ph095_1iOS15RefforAssetAnalysisPhDaPsql(files_found, report_folder, seeker, wrap_text, timezone_offset):
...
@artifact_processor
def Ph095_2iOS15RefforAssetAnalysisSyndPL(files_found, report_folder, seeker, wrap_text, timezone_offset):
	for source_path in files_found:
		source_path = str(source_path)
