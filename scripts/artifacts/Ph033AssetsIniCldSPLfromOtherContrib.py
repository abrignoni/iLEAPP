...
__artifacts_v2__ = {
    'Ph033iCldSPLAssetsfromothercontribPhDaPsql': {
        ...
        'category': 'Photos.sqlite-Assets-iCloudSPL-fromOthers-PhotoData-Psql',
        'notes': '',
...
@artifact_processor
def Ph033iCldSPLAssetsfromothercontribPhDaPsql(files_found, report_folder, seeker, wrap_text, timezone_offset):
