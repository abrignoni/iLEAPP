...
__artifacts__ = {
        "ChromeNetworkActionPredictor": (
                "Chromium",
                ('*/Chrome/Default/Network Action Predictor*','*/app_sbrowser/Default/Network Action Predictor*', '*/app_opera/Network Action Predicator*', '*/Chromium/Default/Network Action Predictor*'),
