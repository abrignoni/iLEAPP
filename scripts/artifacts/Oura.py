__artifacts_v2__ = {
    ...
    "oura_account_identifiers": {
        ...
        "description": "Account e-mail and UIDs plus cross-service identifiers "
                       "and tokens: Segment user/anonymous IDs, Zendesk user id, UUID "
    ...
    "oura_preferences_residue": {
        ...
        "description": "Keys from the Oura preference plists that no topical "
                       "Oura artifact claims: UI state, migration flags, "
