__artifacts_v2__ = {
    "callHistoryTemp": {
        "name": "Call History Temp",
        "description": "Extract Call History Temp",
        ...
        "notes": "",
        "paths": ('*/private/var/mobile/Library/CallHistoryDB/CallHistoryTemp.storedata*',),
...
@artifact_processor
def callHistoryTemp(files_found, report_folder, seeker, wrap_text, timezone_offset):
    data_list = []
    db_file = ''
