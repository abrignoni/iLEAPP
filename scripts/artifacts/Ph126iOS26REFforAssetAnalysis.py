__artifacts_v2__ = {
	'Ph126_1iOS26RefforAssetAnalysisPhDaPsql': {
		...
		'category': 'Photos.sqlite-Z-TableJoinReference-iOS26-PhotoData-Psql',
		'notes': '',
	...
	'Ph126_2iOS26RefforAssetAnalysisSyndPL': {
		...
		'category': 'Photos.sqlite-Z-TableJoinReference-iOS26-SyndicationPL-Psql',
		'notes': '',
	...
	'Ph126_3iOS26RefforAssetAnalysisGenPlayPsql': {
		...
		'category': 'Photos.sqlite-Z-TableJoinReference-iOS26-GenPlaygrndPL-Psql',
        'notes': '',
...
@artifact_processor
def Ph126_1iOS26RefforAssetAnalysisPhDaPsql(files_found, report_folder, seeker, wrap_text, timezone_offset):
	...
	if (version.parse(iosversion) >= version.parse("26")) & (version.parse(iosversion) < version.parse("27")):
        ...
        SELECT 
          ...
          CASE zExtAttr.ZGENERATIVEAITYPE
            WHEN 0 THEN '0-GenAI_Not_Detected Still_Testing-0'
            WHEN 1 THEN '1-Apple_Image_Playground GenAI_Still_Testing-1'
            WHEN 2 THEN '2-Apple_Photo_CleanUP GenAI_Still_Testing-2'
          ...
          DateTime(zAsset.ZADDEDDATE + 978307200, 'UNIXEPOCH') AS 'zAsset-Added Date - datetime',
          DateTime(zAsset.ZSORTTOKEN + 978307200, 'UNIXEPOCH') AS 'zAsset- SortToken -CameraRoll - datetime',
          ...
          DateTime(zAsset.ZDATECREATED + 978307200, 'UNIXEPOCH') AS 'zAsset-Date Created - datetime',
          DateTime(zCldMast.ZCREATIONDATE + 978307200, 'UNIXEPOCH') AS 'zCldMast-Creation Date - datetime',
          DateTime(zIntResou.ZCLOUDMASTERDATECREATED + 978307200, 'UNIXEPOCH') AS 'zIntResou-CldMst Date Created - datetime',
          ...
          DateTime(zAsset.ZMODIFICATIONDATE + 978307200, 'UNIXEPOCH') AS 'zAsset-Modification Date - datetime',
          DateTime(zAddAssetAttr.ZLASTVIEWEDDATE + 978307200, 'UNIXEPOCH') AS 'zAddAssetAttr-Last Viewed Date - datetime',
          DateTime(zAsset.ZLASTSHAREDDATE + 978307200, 'UNIXEPOCH') AS 'zAsset-Last Shared Date - datetime',
          ...
          DateTime(zCldMast.ZIMPORTDATE + 978307200, 'UNIXEPOCH') AS 'zCldMast-Import Date - datetime',
          DateTime(zAddAssetAttr.ZLASTUPLOADATTEMPTDATE + 978307200, 'UNIXEPOCH') AS 'zAddAssetAttr-Last Upload Attempt Date-SWY_Files - datetime',
          zAddAssetAttr.ZIMPORTSESSIONID AS 'zAddAssetAttr-Import Session ID-4QueryStart',
          DateTime(zAddAssetAttr.ZALTERNATEIMPORTIMAGEDATE + 978307200, 'UNIXEPOCH') AS 'zAddAssetAttr-Alt Import Image Date - datetime',
          zCldMast.ZIMPORTSESSIONID AS 'zCldMast-Import Session ID- AirDrop-StillTesting- 4QueryStart',
          DateTime(zAsset.ZCLOUDBATCHPUBLISHDATE + 978307200, 'UNIXEPOCH') AS 'zAsset-Cloud Batch Publish Date - datetime',
          DateTime(zAsset.ZCLOUDSERVERPUBLISHDATE + 978307200, 'UNIXEPOCH') AS 'zAsset-Cloud Server Publish Date - datetime',
          ...
          DateTime(ParentzGenAlbum.ZCREATIONDATE + 978307200, 'UNIXEPOCH') AS 'ParentzGenAlbum- Creation Date- 4QueryStart - datetime',
          DateTime(zGenAlbum.ZCREATIONDATE + 978307200, 'UNIXEPOCH') AS 'zGenAlbum- Creation Date- 4QueryStart - datetime',
          DateTime(SWYConverszGenAlbum.ZCREATIONDATE + 978307200, 'UNIXEPOCH') AS 'SWYConverszGenAlbum- Creation Date- 4QueryStart - datetime',
          DateTime(zGenAlbum.ZCLOUDCREATIONDATE + 978307200, 'UNIXEPOCH') AS 'zGenAlbum- Cloud Creation Date- 4QueryStart - datetime',
          DateTime(SWYConverszGenAlbum.ZCLOUDCREATIONDATE + 978307200, 'UNIXEPOCH') AS 'SWYConverszGenAlbum- Cloud Creation Date- 4QueryStart - datetime',
          DateTime(zGenAlbum.ZSTARTDATE + 978307200, 'UNIXEPOCH') AS 'zGenAlbum- Start Date- 4QueryStart - datetime',
          DateTime(SWYConverszGenAlbum.ZSTARTDATE + 978307200, 'UNIXEPOCH') AS 'SWYConverszGenAlbum- Start Date- 4QueryStart - datetime',
          DateTime(zGenAlbum.ZENDDATE + 978307200, 'UNIXEPOCH') AS 'zGenAlbum- End Date- 4QueryStart - datetime',
          DateTime(SWYConverszGenAlbum.ZENDDATE + 978307200, 'UNIXEPOCH') AS 'SWYConverszGenAlbum- End Date- 4QueryStart - datetime',
          DateTime(zGenAlbum.ZCLOUDSUBSCRIPTIONDATE + 978307200, 'UNIXEPOCH') AS 'zGenAlbum-Cloud Subscription Date- 4QueryStart - datetime',
          DateTime(SWYConverszGenAlbum.ZCLOUDSUBSCRIPTIONDATE + 978307200, 'UNIXEPOCH') AS 'SWYConverszGenAlbum-Cloud Subscription Date- 4QueryStart - datetime',
          DateTime(zShare.ZCLOUDSUBSCRIPTIONDATE + 978307200, 'UNIXEPOCH') AS 'zShare-Cloud Subscription Date-CMM- 4QueryStart - datetime',
          DateTime(SPLzShare.ZCLOUDSUBSCRIPTIONDATE + 978307200, 'UNIXEPOCH') AS 'SPLzShare-Cloud Subscription Date-SPL- 4QueryStart - datetime',
          ...
          CASE zAsset.ZISDETECTEDSCREENSHOT
            WHEN 0 THEN '0-Not_Detected_Screenshot_Still_Testing-0'
            WHEN 1 THEN '1-Detected_Screenshot_Still_Testing-1'
          ...
          END AS 'zIntResou-Cloud Last Prefetch Date - datetime',
          zIntResou.ZCLOUDPREFETCHCOUNT AS 'zIntResou-Cloud Prefetch Count',
          DateTime(zIntResou.ZCLOUDLASTONDEMANDDOWNLOADDATE + 978307200, 'UNIXEPOCH') AS 'zIntResou- Cloud-Last-OnDemand Download-Date - datetime',
          ...
          CASE zAsset.ZADJUSTMENTSSTATE
            ...
            WHEN 2 THEN '2-Yes-Adjustments_needs_update_Decoding-2'
            WHEN 3 THEN '3-Yes-Adjustments_needs_update_Decoding-3'
            ELSE 'Unknown-New-Value!: ' || zAsset.ZADJUSTMENTSSTATE || ''
          END AS 'zAsset-Adjustments_State-Camera-Effects-Filters',
          ...
          DateTime(zAsset.ZADJUSTMENTTIMESTAMP + 978307200, 'UNIXEPOCH') AS 'zAsset-Adjustment Timestamp - datetime',
          DateTime(zUnmAdj.ZADJUSTMENTTIMESTAMP + 978307200, 'UNIXEPOCH') AS 'zUnmAdj-Adjustment Timestamp - datetime',
          DateTime(zCompSyncAttr.ZCLOUDCOMPUTESTATELASTUPDATEDDATE + 978307200, 'UNIXEPOCH') AS 'zCompSyncAttr-Cloud_Compute_State_Last_Updated_Date - datetime',
          ...
          DateTime(zAsset.ZTRASHEDDATE + 978307200, 'UNIXEPOCH') AS 'zAsset-Trashed Date - datetime',
          ...
          DateTime(zIntResou.ZTRASHEDDATE + 978307200, 'UNIXEPOCH') AS 'zIntResou-Trashed Date - datetime',
          ...
          DateTime(zMedAnlyAstAttr.ZMEDIAANALYSISTIMESTAMP + 978307200, 'UNIXEPOCH') AS 'zMedAnlyAstAttr-Media Analysis Timestamp - datetime',
          DateTime(zAsset.ZANALYSISSTATEMODIFICATIONDATE + 978307200, 'UNIXEPOCH') AS 'zAsset-Analysis State Modificaion Date - datetime',
          ...
          DateTime(zAddAssetAttr.ZSCENEANALYSISTIMESTAMP + 978307200, 'UNIXEPOCH') AS 'zAddAssetAttr-Scene Analysis Timestamp - datetime',
          ...
          CASE zAsset.ZCURRENTSLEETCAST
            WHEN 0 THEN '0-ObsButUnkn_Still_Testing-0'
            WHEN 1 THEN '1-NotYetObs_Still_Testing-1'
            ELSE 'Unknown-New-Value!: ' || zAsset.ZCURRENTSLEETCAST || ''
          END AS 'zAsset-Current_Sleet_Cast',
          CASE zAddAssetAttr.ZSLEETISREVERSIBLE
            WHEN 0 THEN '0-Obs in iOS 18 still testing-0'
            WHEN 1 THEN '1-Obs in iOS 18 still testing-1'
            ELSE 'Unknown-New-Value!: ' || zAddAssetAttr.ZSLEETISREVERSIBLE || ''
          END AS 'zAddAssetAttr.Sleet_Is_Reversible',
          ...
          DateTime(zPhotoAnalysisAssetAttr.ZWALLPAPERPROPERTIESTIMESTAMP + 978307200, 'UNIXEPOCH') AS 'zPhotoAnalysisAssetAttr-Wallpaper Properties Timestamp - datetime',
          zPhotoAnalysisAssetAttr.ZWALLPAPERPROPERTIESDATA AS 'zPhotoAnalysisAssetAttr-Wallpaper Properties Data',
          DateTime(zCldFeedEnt.ZENTRYDATE + 978307200, 'UNIXEPOCH') AS 'zCldFeedEnt-Entry Date - datetime',
          ...
          END AS 'zCldFeedEnt-Entry_Is_Mine',
          ...
          CASE zCldFeedEnt.ZENTRYTYPE
            ...
            ELSE 'Unknown-New-Value!: ' || zCldFeedEnt.ZENTRYTYPE || ''
          END AS 'zCldFeedEnt-Entry Type',
          zCldSharedComment.ZCLOUDGUID AS 'zCldSharedComment-Cloud GUID-4TableStart',
          DateTime(zCldSharedComment.ZCOMMENTDATE + 978307200, 'UNIXEPOCH') AS 'zCldSharedComment-Date - datetime',
          DateTime(zCldSharedComment.ZCOMMENTCLIENTDATE + 978307200, 'UNIXEPOCH') AS 'zCldSharedComment-Comment Client Date - datetime',
          DateTime(zAsset.ZCLOUDLASTVIEWEDCOMMENTDATE + 978307200, 'UNIXEPOCH') AS 'zAsset-Cloud Last Viewed Comment Date - datetime',
          ...
          CASE zSharePartic.Z66_SHARE
            WHEN 55 THEN '55-SPL-Entity-55'
            WHEN 56 THEN '56-CMM-iCloud-Link-Entity-56'
            WHEN 63 THEN '63-SPL-Active-Participant-63'
            WHEN 64 THEN '64-CMM-iCloud-Link-64'
            ELSE 'Unknown-New-Value!: ' || zSharePartic.Z66_SHARE || ''
          END AS 'zSharePartic-z66SHARE',
          CASE SPLzSharePartic.Z66_SHARE
            WHEN 55 THEN '55-SPL-Entity-55'
            WHEN 56 THEN '56-CMM-iCloud-Link-Entity-56'
            WHEN 63 THEN '63-SPL-Active-Participant-63'
            WHEN 64 THEN '64-CMM-iCloud-Link-64'
            ELSE 'Unknown-New-Value!: ' || SPLzSharePartic.Z66_SHARE || ''
          END AS 'SPLzSharePartic-z66SHARE',
          CASE zShare.ZSTATUS
          ...
          CASE zShare.ZALLOWSACCESSREQUESTS
            WHEN 0 THEN '0-Does Not Allow Access Requests-0'
            ELSE 'Unknown-New-Value!: ' || zShare.ZALLOWSACCESSREQUESTS || ''
          END AS 'zShare-Allows Access Requests-CMM',
          CASE SPLzShare.ZALLOWSACCESSREQUESTS
            WHEN 0 THEN '0-Does Not Allow Access Requests-0'
            ELSE 'Unknown-New-Value!: ' || SPLzShare.ZALLOWSACCESSREQUESTS || ''
          END AS 'SPLzShare-Allows Access Requests-SPL',
          CASE zShare.ZCOLLECTIONSHARECURRENTUSERCONTRIBUTIONSTATE
            WHEN 1 THEN '1-CollectionShare Cur User Contrib State-stilltesting-1'
            ELSE 'Unknown-New-Value!: ' || zShare.ZCOLLECTIONSHARECURRENTUSERCONTRIBUTIONSTATE || ''
          END AS 'zShare-CollectionShare CurrentUser ContribState-CMM',
          CASE SPLzShare.ZCOLLECTIONSHARECURRENTUSERCONTRIBUTIONSTATE
            WHEN 1 THEN '1-CollectionShare Cur User Contrib State-stilltesting-1'
            ELSE 'Unknown-New-Value!: ' || SPLzShare.ZCOLLECTIONSHARECURRENTUSERCONTRIBUTIONSTATE || ''
          END AS 'SPLzShare-CollectionShare CurrentUser ContribState-SPL',
          CASE zShare.ZCOLLECTIONSHAREEXPIRINGSTATE
            WHEN 0 THEN '0-CollectionShare Expiring State-stilltesting-0'
            ELSE 'Unknown-New-Value!: ' || zShare.ZCOLLECTIONSHAREEXPIRINGSTATE || ''
          END AS 'zShare-CollectionShare ExpiringState-CMM',
          CASE SPLzShare.ZCOLLECTIONSHAREEXPIRINGSTATE
            WHEN 0 THEN '0-CollectionShare Expiring State-stilltesting-0'
            ELSE 'Unknown-New-Value!: ' || SPLzShare.ZCOLLECTIONSHAREEXPIRINGSTATE || ''
          END AS 'SPLzShare-CollectionShare ExpiringState-SPL',
          CASE zShare.ZCOLLECTIONSHAREKIND
            WHEN 2 THEN '2-CollectionShare Kind-stilltesting-2'
            ELSE 'Unknown-New-Value!: ' || zShare.ZCOLLECTIONSHAREKIND || ''
          END AS 'zShare-CollectionShare Kind-CMM',
          CASE SPLzShare.ZCOLLECTIONSHAREKIND
            WHEN 2 THEN '2-CollectionShare Kind-stilltesting-2'
            ELSE 'Unknown-New-Value!: ' || SPLzShare.ZCOLLECTIONSHAREKIND || ''
          END AS 'SPLzShare-CollectionShare Kind-SPL',
          CASE zShare.ZCREATIONTYPE
            WHEN 0 THEN '0-Creation Type-stilltesting-0'
            ELSE 'Unknown-New-Value!: ' || zShare.ZCREATIONTYPE || ''
          END AS 'zShare-Creation Type-CMM',
          CASE SPLzShare.ZCREATIONTYPE
            WHEN 0 THEN '0-Creation Type-stilltesting-0'
            ELSE 'Unknown-New-Value!: ' || SPLzShare.ZCREATIONTYPE || ''
          END AS 'SPLzShare-Creation Type-SPL',
          ...
          zShare.ZCLIENTBUNDLEIDENTIFIER AS 'zShare-Client BundleID-CMM',
          SPLzShare.ZCLIENTBUNDLEIDENTIFIER AS 'SPLzShare-Client BundleID-SPL',
          DateTime(zShare.ZCREATIONDATE + 978307200, 'UNIXEPOCH') AS 'zShare-Creation Date-CMM - datetime',
          DateTime(SPLzShare.ZCREATIONDATE + 978307200, 'UNIXEPOCH') AS 'SPLzShare-Creation Date-SPL - datetime',
          DateTime(zShare.ZSTARTDATE + 978307200, 'UNIXEPOCH') AS 'zShare-Start Date-CMM - datetime',
          DateTime(SPLzShare.ZSTARTDATE + 978307200, 'UNIXEPOCH') AS 'SPLzShare-Start Date-SPL - datetime',
          DateTime(zShare.ZCLOUDSUBSCRIPTIONDATE + 978307200, 'UNIXEPOCH') AS 'zShare-Cloud Subscription Date-CMM- 4zShare - datetime',
          DateTime(SPLzShare.ZCLOUDSUBSCRIPTIONDATE + 978307200, 'UNIXEPOCH') AS 'SPLzShare-Cloud Subscription Date-SPL- 4zShare - datetime',
          DateTime(zShare.ZENDDATE + 978307200, 'UNIXEPOCH') AS 'zShare-End Date-CMM - datetime',
          DateTime(SPLzShare.ZENDDATE + 978307200, 'UNIXEPOCH') AS 'SPLzShare-End Date-SPL - datetime',
          DateTime(zShare.ZEXPIRYDATE + 978307200, 'UNIXEPOCH') AS 'zShare-Expiry Date-CMM - datetime',
          DateTime(SPLzShare.ZEXPIRYDATE + 978307200, 'UNIXEPOCH') AS 'SPLzShare-Expiry Date-SPL - datetime',
          DateTime(zShare.ZLASTMODIFIEDDATE + 978307200, 'UNIXEPOCH') AS 'zShare-Last Modified Date-CMM - datetime',
          DateTime(SPLzShare.ZLASTMODIFIEDDATE + 978307200, 'UNIXEPOCH') AS 'SPLzShare-Last Modified Date-SPL - datetime',
          ...
          zShare.ZUNSEENASSETSCOUNT AS 'zShare-Unseen Assets Count-CMM',
          SPLzShare.ZUNSEENASSETSCOUNT AS 'SPLzShare-Unseen Assets Count-SPL',
          CASE zShare.ZUNSEENCONTENTSTATE
            WHEN 1 THEN '1-Unseen Content State-stilltesting-1'
            ELSE 'Unknown-New-Value!: ' || zShare.ZUNSEENCONTENTSTATE || ''
          END AS 'zShare-Unseen Content State-CMM',
          CASE SPLzShare.ZUNSEENCONTENTSTATE
            WHEN 1 THEN '1-Unseen Content State-stilltesting-1'
            ELSE 'Unknown-New-Value!: ' || SPLzShare.ZUNSEENCONTENTSTATE || ''
          END AS 'SPLzShare-Unseen Content State-SPL',
          ...
          CASE zShare.ZSCOPESYNCINGSTATE
            WHEN 0 THEN '0-ScopeNOTAllowedToSync-SPL-StillTesting-0'
          ...
          CASE zShare.ZSCOPESYNCINGSTATE1
            WHEN 0 THEN '0-ScopeNOTAllowedToSync-SPL-StillTesting-0'
            WHEN 1 THEN '1-ScopeAllowedToSync-SPL-StillTesting-1'
            ELSE 'Unknown-New-Value!: ' || zShare.ZSCOPESYNCINGSTATE1 || ''
          END AS 'zShare-Scope Syncing State1-CMM',
          CASE SPLzShare.ZSCOPESYNCINGSTATE1
            WHEN 0 THEN '0-ScopeNOTAllowedToSync-SPL-StillTesting-0'
            WHEN 1 THEN '1-ScopeAllowedToSync-SPL-StillTesting-1'
            ELSE 'Unknown-New-Value!: ' || SPLzShare.ZSCOPESYNCINGSTATE1 || ''
          END AS 'SPLzShare-Scope Syncing State1-SPL',
          ...
          DateTime(zShare.ZTRASHEDDATE + 978307200, 'UNIXEPOCH') AS 'zShare-Trashed Date-CMM - datetime',
          DateTime(SPLzShare.ZTRASHEDDATE + 978307200, 'UNIXEPOCH') AS 'SPLzShare-Trashed Date-SPL - datetime',
          DateTime(zShare.ZLASTPARTICIPANTASSETTRASHNOTIFICATIONDATE + 978307200, 'UNIXEPOCH') AS 'zShare-LastParticipant Asset Trash Notification Date-CMM - datetime',
          DateTime(SPLzShare.ZLASTPARTICIPANTASSETTRASHNOTIFICATIONDATE + 978307200, 'UNIXEPOCH') AS 'SPLzShare-LastParticipant Asset Trash Notification Date-SPL - datetime',
          DateTime(zShare.ZLASTPARTICIPANTASSETTRASHNOTIFICATIONVIEWEDDATE + 978307200, 'UNIXEPOCH') AS 'zShare-Last Participant Asset Trash Notification View Date-CMM - datetime',
          DateTime(SPLzShare.ZLASTPARTICIPANTASSETTRASHNOTIFICATIONVIEWEDDATE + 978307200, 'UNIXEPOCH') AS 'SPLzShare-Last Participant Asset Trash Notification View Date-SPL - datetime',
          ...
          zShare.ZPHONEINVITATIONTOKEN AS 'zShare-Phone Invitation Token-CMM',
          SPLzShare.ZPHONEINVITATIONTOKEN AS 'SPLzShare-Phone Invitation Token-SPL',
          zShare.ZCKSHAREDATA AS 'zShare-CK Share Data-CMM',
          SPLzShare.ZCKSHAREDATA AS 'SPLzShare-CK Share Data-SPL',
          ...
          DateTime(ParentzGenAlbum.ZCREATIONDATE + 978307200, 'UNIXEPOCH') AS 'ParentzGenAlbum-Creation Date - datetime',
          DateTime(zGenAlbum.ZCREATIONDATE + 978307200, 'UNIXEPOCH') AS 'zGenAlbum-Creation Date - datetime',
          DateTime(SWYConverszGenAlbum.ZCREATIONDATE + 978307200, 'UNIXEPOCH') AS 'SWYConverszGenAlbum-Creation Date - datetime',
          DateTime(zGenAlbum.ZCLOUDCREATIONDATE + 978307200, 'UNIXEPOCH') AS 'zGenAlbum-Cloud Creation Date - datetime',
          DateTime(SWYConverszGenAlbum.ZCLOUDCREATIONDATE + 978307200, 'UNIXEPOCH') AS 'SWYConverszGenAlbum-Cloud Creation Date - datetime',
          DateTime(zGenAlbum.ZSTARTDATE + 978307200, 'UNIXEPOCH') AS 'zGenAlbum-Start Date - datetime',
          DateTime(SWYConverszGenAlbum.ZSTARTDATE + 978307200, 'UNIXEPOCH') AS 'SWYConverszGenAlbum-Start Date - datetime',
          DateTime(zGenAlbum.ZENDDATE + 978307200, 'UNIXEPOCH') AS 'zGenAlbum-End Date - datetime',
          DateTime(SWYConverszGenAlbum.ZENDDATE + 978307200, 'UNIXEPOCH') AS 'SWYConverszGenAlbum-End Date - datetime',
          DateTime(zGenAlbum.ZCLOUDSUBSCRIPTIONDATE + 978307200, 'UNIXEPOCH') AS 'zGenAlbum-Cloud Subscription Date - datetime',
          DateTime(SWYConverszGenAlbum.ZCLOUDSUBSCRIPTIONDATE + 978307200, 'UNIXEPOCH') AS 'SWYConverszGenAlbum-Cloud Subscription Date - datetime',
          DateTime(zShare.ZCLOUDSUBSCRIPTIONDATE + 978307200, 'UNIXEPOCH') AS 'zShare-Cloud Subscription Date-CMM - datetime',
          DateTime(SPLzShare.ZCLOUDSUBSCRIPTIONDATE + 978307200, 'UNIXEPOCH') AS 'SPLzShare-Cloud Subscription Date-SPL - datetime',
          ...
          zShare.ZCLOUDPERSONID AS 'zShare-Cloud Person ID-CMM',
          SPLzShare.ZCLOUDPERSONID AS 'SPLzShare-Cloud Person ID-SPL',
          ...
          DateTime(zGenAlbum.ZCLOUDLASTCONTRIBUTIONDATE + 978307200, 'UNIXEPOCH') AS 'zGenAlbum-Cloud Contribution Date - datetime',
          DateTime(SWYConverszGenAlbum.ZCLOUDLASTCONTRIBUTIONDATE + 978307200, 'UNIXEPOCH') AS 'SWYConverszGenAlbum-Cloud Contribution Date - datetime',
          DateTime(zGenAlbum.ZCLOUDLASTINTERESTINGCHANGEDATE + 978307200, 'UNIXEPOCH') AS 'zGenAlbum-Cloud Last Interesting Change Date - datetime',
          DateTime(SWYConverszGenAlbum.ZCLOUDLASTINTERESTINGCHANGEDATE + 978307200, 'UNIXEPOCH') AS 'SWYConverszGenAlbum-Cloud Last Interesting Change Date - datetime',
          ...
          DateTime(ParentzGenAlbum.ZTRASHEDDATE + 978307200, 'UNIXEPOCH') AS 'ParentzGenAlbum-Trash Date - datetime',
          ...
          DateTime(zGenAlbum.ZTRASHEDDATE + 978307200, 'UNIXEPOCH') AS 'zGenAlbum-Trash Date - datetime',
          ...
          DateTime(SWYConverszGenAlbum.ZTRASHEDDATE + 978307200, 'UNIXEPOCH') AS 'SWYConverszGenAlbum-Trash Date - datetime',
          ...
          DateTime(zCldShareAlbumInvRec.ZINVITEESUBSCRIPTIONDATE + 978307200, 'UNIXEPOCH') AS 'zCldShareAlbumInvRec-Subscription Date - datetime',
          ...
          zPerson.ZISMECONFIDENCE AS 'zPerson-Is_Me_Confidence-4TableStart',
          ...
          DateTime(zMemory.ZCREATIONDATE + 978307200, 'UNIXEPOCH') AS 'zMemory-Creation Date - datetime',
          DateTime(zMemory.ZLASTENRICHMENTDATE + 978307200, 'UNIXEPOCH') AS 'zMemory-Last Enrichment Date - datetime',
          ...
          DateTime(zMemory.ZLASTMOVIEPLAYEDDATE + 978307200, 'UNIXEPOCH') AS 'zMemory-Last Movie Play Date - datetime',
          DateTime(zMemory.ZLASTVIEWEDDATE + 978307200, 'UNIXEPOCH') AS 'zMemory-Last Viewed Date - datetime',
          ...
          DateTime(zMoment.ZSTARTDATE + 978307200, 'UNIXEPOCH') AS 'zMoment-Start Date - datetime',
          DateTime(zMoment.ZREPRESENTATIVEDATE + 978307200, 'UNIXEPOCH') AS 'zMoment-Representative Date - datetime',
          zMoment.ZTIMEZONEOFFSET AS 'zMoment-Timezone Offset',
          DateTime(zMoment.ZMODIFICATIONDATE + 978307200, 'UNIXEPOCH') AS 'zMoment-Modification Date - datetime',
          DateTime(zMoment.ZENDDATE + 978307200, 'UNIXEPOCH') AS 'zMoment-End Date - datetime',
          ...
          DateTime(SBKAzSugg.ZSTARTDATE + 978307200, 'UNIXEPOCH') AS 'SBKAzSugg-Start Date - datetime',
          ...
          DateTime(SBKAzSugg.ZCREATIONDATE + 978307200, 'UNIXEPOCH') AS 'SBKAzSugg-Creation Date - datetime',
          DateTime(SBKAzSugg.ZENDDATE + 978307200, 'UNIXEPOCH') AS 'SBKAzSugg-End Date - datetime',
          DateTime(SBKAzSugg.ZACTIVATIONDATE + 978307200, 'UNIXEPOCH') AS 'SBKAzSugg-Activation Date - datetime',
          DateTime(SBKAzSugg.ZEXPUNGEDATE + 978307200, 'UNIXEPOCH') AS 'SBKAzSugg-Expunge Date - datetime',
          DateTime(SBKAzSugg.ZRELEVANTUNTILDATE + 978307200, 'UNIXEPOCH') AS 'SBKAzSugg-Relevant Until Date - datetime',
          ...
          DateTime(SBRAzSugg.ZSTARTDATE + 978307200, 'UNIXEPOCH') AS 'SBRAzSugg-Start Date - datetime',
          ...
          DateTime(SBRAzSugg.ZCREATIONDATE + 978307200, 'UNIXEPOCH') AS 'SBRAzSugg-Creation Date - datetime',
          DateTime(SBRAzSugg.ZENDDATE + 978307200, 'UNIXEPOCH') AS 'SBRAzSugg-End Date - datetime',
          DateTime(SBRAzSugg.ZACTIVATIONDATE + 978307200, 'UNIXEPOCH') AS 'SBRAzSugg-Activation Date - datetime',
          DateTime(SBRAzSugg.ZEXPUNGEDATE + 978307200, 'UNIXEPOCH') AS 'SBRAzSugg-Expunge Date - datetime',
          DateTime(SBRAzSugg.ZRELEVANTUNTILDATE + 978307200, 'UNIXEPOCH') AS 'SBRAzSugg-Relevant Until Date - datetime',
          ...
          DateTime(zAssetAnalyState.ZIGNOREUNTILDATE + 978307200, 'UNIXEPOCH') AS 'zAssetAnalyState-Ignore Until Date - datetime',
          DateTime(zAssetAnalyState.ZLASTIGNOREDDATE + 978307200, 'UNIXEPOCH') AS 'zAssetAnalyState-Last Ignored Date - datetime',
          ...
          zEditedIPTCAttr.ZASSETATTRIBUTES AS 'zEdIPTCAttr-Asset Attributes= zAddAssetAttr.zPK',
          zEditedIPTCAttr.ZACTIONADVISED AS 'zEdIPTCAttr-Action Advised',
          zEditedIPTCAttr.ZAUDIODURATION AS 'zEdIPTCAttr-Audio Duration',
          zEditedIPTCAttr.ZAUDIOOUTCUE AS 'zEdIPTCAttr-Audio Outcue',
          zEditedIPTCAttr.ZAUDIOSAMPLINGRATE AS 'zEdIPTCAttr-Audio Sampling Rate',
          zEditedIPTCAttr.ZAUDIOSAMPLINGRES AS 'zEdIPTCAttr-Audio Sampling Res',
          zEditedIPTCAttr.ZAUDIOTYPE AS 'zEdIPTCAttr-Audion Type',
          zEditedIPTCAttr.ZBYLINE AS 'zEdIPTCAttr-ByLine',
          zEditedIPTCAttr.ZBYLINETITLE AS 'zEdIPTCAttr-ByLine Title',
          zEditedIPTCAttr.ZCAPTION AS 'zEdIPTCAttr-Caption',
          zEditedIPTCAttr.ZCATEGORY AS 'zEdIPTCAttr-Category',
          zEditedIPTCAttr.ZCIADRCITY AS 'zEdIPTCAttr-CIADR City',
          zEditedIPTCAttr.ZCIADRCTRY AS 'zEdIPTCAttr-CIADR Ctry',
          zEditedIPTCAttr.ZCIADREXTADR AS 'zEdIPTCAttr-CIADR ExtAdr',
          zEditedIPTCAttr.ZCIADRPCODE AS 'zEdIPTCAttr-CIADR PCode',
          zEditedIPTCAttr.ZCIADRREGION AS 'zEdIPTCAttr-CIADR Region',
          zEditedIPTCAttr.ZCIEMAILWORK AS 'zEdIPTCAttr-CiEmailWork',
          zEditedIPTCAttr.ZCITELWORK AS 'zEdIPTCAttr-CiTeLWork',
          zEditedIPTCAttr.ZCIURLWORK AS 'zEdIPTCAttr-CiURLWork',
          zEditedIPTCAttr.ZCITY AS 'zEdIPTCAttr-City',
          zEditedIPTCAttr.ZCONTACT AS 'zEdIPTCAttr-Contact',
          zEditedIPTCAttr.ZCONTENTLOCATIONCODE AS 'zEdIPTCAttr-Content LocationCode',
          zEditedIPTCAttr.ZCONTENTLOCATIONNAME AS 'zEdIPTCAttr-Content LocationName',
          zEditedIPTCAttr.ZCOPYRIGHTNOTICE AS 'zEdIPTCAttr-Copy Right Notice',
          zEditedIPTCAttr.ZCOUNTRYPRIMARYLOCATIONCODE AS 'zEdIPTCAttr-Cntry Primary LocationCode',
          zEditedIPTCAttr.ZCOUNTRYPRIMARYLOCATIONNAME AS 'zEdIPTCAttr-Cntry Primary LocationName',
          zEditedIPTCAttr.ZCREATORCONTACTINFO AS 'zEdIPTCAttr-Creator ContactInfo',
          zEditedIPTCAttr.ZCREDIT AS 'zEdIPTCAttr-Credit',
          zEditedIPTCAttr.ZDATECREATED AS 'zEdIPTCAttr-DateCreated-TEXT',
          zEditedIPTCAttr.ZDIGITALCREATIONDATE AS 'zEdIPTCAttr-Dig Creation Date - TEXT',
          zEditedIPTCAttr.ZDIGITALCREATIONTIME AS 'zEdIPTCAttr-Dig Creation Time - TEXT',
          zEditedIPTCAttr.ZDIGITALSOURCETYPE AS 'zEdIPTCAttr-Dig SourceType',
          zEditedIPTCAttr.ZEDITSTATUS AS 'zEdIPTCAttr-EditStatus',
          zEditedIPTCAttr.ZEDITORIALUPDATE AS 'zEdIPTCAttr-EditorAL Update',
          zEditedIPTCAttr.ZEXPIRATIONDATE AS 'zEdIPTCAttr-Exp Date - TEXT',
          zEditedIPTCAttr.ZEXPIRATIONTIME AS 'zEdIPTCAttr-Exp Time - TEXT',
          zEditedIPTCAttr.ZFIXTUREIDENTIFIER AS 'zEdIPTCAttr-Fixture ID',
          zEditedIPTCAttr.ZHEADLINE AS 'zEdIPTCAttr-Headline',
          zEditedIPTCAttr.ZIMAGEORIENTATION AS 'zEdIPTCAttr-Image Orientation',
          zEditedIPTCAttr.ZIMAGETYPE AS 'zEdIPTCAttr-Image Type',
          zEditedIPTCAttr.ZKEYWORDS AS 'zEdIPTCAttr-Keywords',
          zEditedIPTCAttr.ZLANGUAGEIDENTIFIER AS 'zEdIPTCAttr-Language ID',
          zEditedIPTCAttr.ZOBJECTATTRIBUTEREFERENCE AS 'zEdIPTCAttr-Obj Attr Reference',
          zEditedIPTCAttr.ZOBJECTCYCLE AS 'zEdIPTCAttr-Obj Cycle',
          zEditedIPTCAttr.ZOBJECTNAME AS 'zEdIPTCAttr-Obj Name',
          zEditedIPTCAttr.ZOBJECTTYPEREFERENCE AS 'zEdIPTCAttr-Obj Type Ref',
          zEditedIPTCAttr.ZORIGINALTRANSMISSIONREFERENCE AS 'zEdIPTCAttr-Org Transmission Ref',
          zEditedIPTCAttr.ZORIGINATINGPROGRAM AS 'zEdIPTCAttr-Orginating Program',
          zEditedIPTCAttr.ZPROGRAMVERSION AS 'zEdIPTCAttr-Program Version',
          zEditedIPTCAttr.ZPROVINCESTATE AS 'zEdIPTCAttr-Province State',
          zEditedIPTCAttr.ZREFERENCEDATE AS 'zEdIPTCAttr-RefDate - TEXT',
          zEditedIPTCAttr.ZREFERENCENUMBER AS 'zEdIPTCAttr-RefNumber',
          zEditedIPTCAttr.ZREFERENCESERVICE AS 'zEdIPTCAttr-RefService',
          zEditedIPTCAttr.ZRELEASEDATE AS 'zEdIPTCAttr-Release Date - TEXT',
          zEditedIPTCAttr.ZRELEASETIME AS 'zEdIPTCAttr-Release Time - TEXT',
          zEditedIPTCAttr.ZSCENE AS 'zEdIPTCAttr-Scene',
          zEditedIPTCAttr.ZSOURCE AS 'zEdIPTCAttr-Source',
          zEditedIPTCAttr.ZSPECIALINSTRUCTIONS AS 'zEdIPTCAttr-Spec Instructions',
          zEditedIPTCAttr.ZSTARRATING AS 'zEdIPTCAttr-Star Rating',
          zEditedIPTCAttr.ZSUBLOCATION AS 'zEdIPTCAttr-SubLocation',
          zEditedIPTCAttr.ZSUBJECTREFERENCE AS 'zEdIPTCAttr-Subject Ref',
          zEditedIPTCAttr.ZSUPPLEMENTALCATEGORY AS 'zEdIPTCAttr-Supplemental Category',
          zEditedIPTCAttr.ZTIMECREATED AS 'zEdIPTCAttr-Time Created - TEXT',
          zEditedIPTCAttr.ZURGENCY AS 'zEdIPTCAttr-Urgency',
          zEditedIPTCAttr.ZUSAGETERMS AS 'zEdIPTCAttr-Usage Terms',
          zEditedIPTCAttr.ZWRITEREDITOR AS 'zEdIPTCAttr-Writer Editor',
          zEditedIPTCAttr.ZDATA AS 'zEdIPTCAttr-Data - BLOB',
          ...
          zEditedIPTCAttr.Z_PK AS 'zEdIPTCAttr-zPK',
          zEditedIPTCAttr.Z_ENT AS 'zEdIPTCAttr-zENT',
          zEditedIPTCAttr.Z_OPT AS 'zEdIPTCAttr-zOPT',
          ...
          zGenAlbum.Z_PK AS 'zGenAlbum-zPK=32AlbumLists= 32Albums',
          ...
          z3SuggBRA.Z_3REPRESENTATIVESUGGESTIONASSETS AS 'z3SuggBRA-3RepAssets',
          z3SuggBRA.Z_71SUGGESTIONSBEINGREPRESENTATIVEASSETS AS 'z3SuggBRA-71SuggBeingRepAssets',
          z3SuggBKA.Z_71SUGGESTIONSBEINGKEYASSETS AS 'z3SuggBKA-71SuggBeingKeyAssets= zSugg-zPK',
          ...
          z32AlbumLists.Z_32ALBUMS AS 'z32AlbumList-32Albums= zGenAlbum-zPK',
          z32AlbumLists.Z_2ALBUMLISTS AS 'z32AlbumList-Album List Key',
          z32AlbumLists.Z_FOK_32ALBUMS AS 'z32AlbumList-FOK32Albums Key',
          z33Assets.Z_33ALBUMS AS 'z33Assets-33Albums= zGenAlbum-zPK',
          z33Assets.Z_3ASSETS AS 'z33Assets-3Asset Key= zAsset-zPK in the Album',
          z33Assets.Z_FOK_3ASSETS AS 'z33Assets-FOK-3Assets= zAsset.Z_FOK_CLOUDFEEDASSETSENTRY',
          ...
          z3MemoryBCAs.Z_56MEMORIESBEINGCURATEDASSETS AS 'z3MemoryBCAs-56memoriesBeingCuratedAssets= zMemory-zPK',
          z3MemoryBECAs.Z_3EXTENDEDCURATEDASSETS AS 'z3MemoryBECAs-3ExtCuratedAssets= zAsset-zPK',
          z3MemoryBECAs.Z_56MEMORIESBEINGEXTENDEDCURATEDASSETS AS 'z3MemoryBECAs-56MemoriesBeingExtCuratedAssets= zMemory-zPK',
          z3MemoryBRAs.Z_3REPRESENTATIVEASSETS AS 'z3MemoryBRAs-3RepresentativeAssets= zAsset-zPK',
          z3MemoryBRAs.Z_56MEMORIESBEINGREPRESENTATIVEASSETS AS 'z3MemoryBRAs-56RepresentativeAssets= zMemory-zPK',
          z3MemoryBUCAs.Z_3USERCURATEDASSETS AS 'z3MemoryBUCAs-3UserCuratedAssets= zAsset-zPK',
          z3MemoryBUCAs.Z_56MEMORIESBEINGUSERCURATEDASSETS AS 'z3MemoryBUCAs-56MemoriesBeingUserCuratedAssets= zMemory-zPK',
          z3MemoryBCUAs.Z_56MEMORIESBEINGCUSTOMUSERASSETS AS 'z3MemoryBCAs-56Memories Being Custom User Assets',
        ...
        FROM ZASSET zAsset
          ...
          LEFT JOIN ZEDITEDIPTCATTRIBUTES zEditedIPTCAttr ON zEditedIPTCAttr.Z_PK = zAddAssetAttr.ZEDITEDIPTCATTRIBUTES
          LEFT JOIN ZSCENEPRINT zSceneP ON zSceneP.Z_PK = zAddAssetAttr.ZSCENEPRINT
          LEFT JOIN Z_33ASSETS z33Assets ON z33Assets.Z_3ASSETS = zAsset.Z_PK
          LEFT JOIN ZGENERICALBUM zGenAlbum ON zGenAlbum.Z_PK = z33Assets.Z_33ALBUMS
          ...
          LEFT JOIN ZMEMORY zMemory ON z3MemoryBCAs.Z_56MEMORIESBEINGCURATEDASSETS = zMemory.Z_PK
          LEFT JOIN Z_3MEMORIESBEINGCUSTOMUSERASSETS z3MemoryBCUAs ON zAsset.Z_PK = z3MemoryBCUAs.Z_3CUSTOMUSERASSETS AND z3MemoryBCUAs.Z_56MEMORIESBEINGCUSTOMUSERASSETS = zMemory.Z_PK
          LEFT JOIN Z_3MEMORIESBEINGEXTENDEDCURATEDASSETS z3MemoryBECAs ON zAsset.Z_PK = z3MemoryBECAs.Z_3EXTENDEDCURATEDASSETS AND z3MemoryBECAs.Z_56MEMORIESBEINGEXTENDEDCURATEDASSETS = zMemory.Z_PK
          LEFT JOIN Z_3MEMORIESBEINGMOVIECURATEDASSETS z3MemoryBMCAs ON zAsset.Z_PK = z3MemoryBMCAs.Z_3MOVIECURATEDASSETS AND z3MemoryBMCAs.Z_56MEMORIESBEINGMOVIECURATEDASSETS = zMemory.Z_PK
          LEFT JOIN Z_3MEMORIESBEINGREPRESENTATIVEASSETS z3MemoryBRAs ON zAsset.Z_PK = z3MemoryBRAs.Z_3REPRESENTATIVEASSETS AND z3MemoryBRAs.Z_56MEMORIESBEINGREPRESENTATIVEASSETS = zMemory.Z_PK
          LEFT JOIN Z_3MEMORIESBEINGUSERCURATEDASSETS z3MemoryBUCAs ON zAsset.Z_PK = z3MemoryBUCAs.Z_3USERCURATEDASSETS AND z3MemoryBUCAs.Z_56MEMORIESBEINGUSERCURATEDASSETS = zMemory.Z_PK
          ...
          LEFT JOIN ZSUGGESTION SBKAzSugg ON SBKAzSugg.Z_PK = z3SuggBKA.Z_71SUGGESTIONSBEINGKEYASSETS
          LEFT JOIN Z_3SUGGESTIONSBEINGREPRESENTATIVEASSETS z3SuggBRA ON z3SuggBRA.Z_3REPRESENTATIVESUGGESTIONASSETS = zAsset.Z_PK
          LEFT JOIN ZSUGGESTION SBRAzSugg ON SBRAzSugg.Z_PK = z3SuggBRA.Z_71SUGGESTIONSBEINGREPRESENTATIVEASSETS
		...
		for row in db_records:
			data_list.append((row[0], row[1], row[2], row[3], row[4], row[5], row[6], row[7], row[8], row[9],
                                ...
                                row[1248], row[1249], row[1250], row[1251], row[1252], row[1253]))
		...
		data_headers = ('zAsset Complete-0',
                        ...
                        'zAsset-Capture_Session_Identifier-24',
                        ...
                        ('zAsset-Added Date - datetime-44',  'datetime'),
                        ('zAsset- SortToken -CameraRoll - datetime-45',  'datetime'),
                        'zAddAssetAttr-Date Created Source-46',
                        ('zAsset-Date Created - datetime-47',  'datetime'),
                        ('zCldMast-Creation Date - datetime-48',  'datetime'),
                        ('zIntResou-CldMst Date Created - datetime-49',  'datetime'),
                        ...
                        ('zAsset-Modification Date - datetime-54',  'datetime'),
                        ('zAddAssetAttr-Last Viewed Date - datetime-55',  'datetime'),
                        ('zAsset-Last Shared Date - datetime-56',  'datetime'),
                        'zCldMast-Cloud Local State-57',
                        ('zCldMast-Import Date - datetime-58',  'datetime'),
                        ('zAddAssetAttr-Last Upload Attempt Date-SWY_Files - datetime-59',  'datetime'),
                        'zAddAssetAttr-Import Session ID-4QueryStart-60',
                        ('zAddAssetAttr-Alt Import Image Date - datetime-61',  'datetime'),
                        'zCldMast-Import Session ID- AirDrop-StillTesting- 4QueryStart-62',
                        ('zAsset-Cloud Batch Publish Date - datetime-63',  'datetime'),
                        ('zAsset-Cloud Server Publish Date - datetime-64',  'datetime'),
                        ...
                        ('ParentzGenAlbum- Creation Date- 4QueryStart - datetime-92',  'datetime'),
                        ('zGenAlbum- Creation Date- 4QueryStart - datetime-93',  'datetime'),
                        ('SWYConverszGenAlbum- Creation Date- 4QueryStart - datetime-94',  'datetime'),
                        ('zGenAlbum- Cloud Creation Date- 4QueryStart - datetime-95',  'datetime'),
                        ('SWYConverszGenAlbum- Cloud Creation Date- 4QueryStart - datetime-96',  'datetime'),
                        ('zGenAlbum- Start Date- 4QueryStart - datetime-97',  'datetime'),
                        ('SWYConverszGenAlbum- Start Date- 4QueryStart - datetime-98',  'datetime'),
                        ('zGenAlbum- End Date- 4QueryStart - datetime-99',  'datetime'),
                        ('SWYConverszGenAlbum- End Date- 4QueryStart - datetime-100',  'datetime'),
                        ('zGenAlbum-Cloud Subscription Date- 4QueryStart - datetime-101',  'datetime'),
                        ('SWYConverszGenAlbum-Cloud Subscription Date- 4QueryStart - datetime-102',  'datetime'),
                        ('zShare-Cloud Subscription Date-CMM- 4QueryStart - datetime-103',  'datetime'),
                        ('SPLzShare-Cloud Subscription Date-SPL- 4QueryStart - datetime-104',  'datetime'),
                        'ParentzGenAlbum- Title- 4QueryStart-105',
                        'zGenAlbum- Title-User&System Applied- 4QueryStart-106',
                        'SWYConverszGenAlbum- Title -User&System Applied- 4QueryStart-107',
                        'zGenAlbum-Import Session ID-SWY- 4QueryStart-108',
                        'zAsset- Conversation= zGenAlbum_zPK -4QueryStart-109',
                        'SWYConverszGenAlbum- Import Session ID-SWY- 4QueryStart-110',
                        'zGenAlbum-Imported by Bundle Identifier- 4QueryStart-111',
                        'SWYzGenAlbum-Imported by Bundle Identifier- 4QueryStart-112',
                        'SWYConverszGenAlbum- Syndicate-4QueryStart-113',
                        'zGenAlbum-zENT- Entity- 4QueryStart-114',
                        'ParentzGenAlbum- Kind- 4QueryStart-115',
                        'zGenAlbum-Album Kind- 4QueryStart-116',
                        'SWYConverszGenAlbum-Album Kind- 4QueryStart-117',
                        'AAAzCldMastMedData-zOPT-4TableStart-118',
                        'zAddAssetAttr-Media Metadata Type-119',
                        'zAddAssetAttr-MediaMetadata= AAAzCldMastMedData-zPK-120',
                        'AAAzCldMastMedData-zPK= zAddAssetAttr&zCldMast-MediaMetaData-121',
                        'AAAzCldMastMedData-Data-HEX-122',
                        'CldMasterzCldMastMedData-zOPT-4TableStart-123',
                        'zCldMast-Media Metadata Type-124',
                        'zCldMast-Media Metadata Key= zCldMastMedData.zPK-125',
                        'CMzCldMastMedData-zPK= zAddAssetAttr&zCldMast-MediaMetaData Key-126',
                        'CMzCldMastMedData-Data-HEX-127',
                        'zAsset-Search Index Rebuild State-128',
                        'zAddAssetAttr-Syndication History-129',
                        'zMedAnlyAstAttr-Syndication Processing Version-130',
                        'zMedAnlyAstAttr-Syndication Processing Value-131',
                        'zAsset-Orientation-132',
                        'zAddAssetAttr-Original Orientation-133',
                        'zAsset-Kind-134',
                        'zAsset-Is_Detected_Screenshot-135',
                        'zAsset-Kind-Sub-Type-136',
                        'zAddAssetAttr-Cloud Kind Sub Type-137',
                        'zAsset-Playback Style-138',
                        'zAsset-Playback Variation-139',
                        'zAddAssetAttr.View_Presentation-140',
                        'zAsset-Video Duration-141',
                        'zExtAttr-Duration-142',
                        'zAsset-Video CP Duration-143',
                        'zAddAssetAttr-Video CP Duration Time Scale-144',
                        'zAsset-Video CP Visibility State-145',
                        'zAddAssetAttr-Video CP Display Value-146',
                        'zAddAssetAttr-Video CP Display Time Scale-147',
                        'zIntResou-Datastore Class ID-148',
                        'zIntResou-Local Availability-149',
                        'zIntResou-Local Availability Target-150',
                        'zIntResou-Cloud Local State-151',
                        'zIntResou-Remote Availability-152',
                        'zIntResou-Remote Availability Target-153',
                        ...
                        ('zIntResou-Cloud Last Prefetch Date - datetime-168',  'datetime'),
                        'zIntResou-Cloud Prefetch Count-169',
                        ('zIntResou- Cloud-Last-OnDemand Download-Date - datetime-170',  'datetime'),
                        ...
                        'zAsset-Adjustments_State-Camera-Effects-Filters-195',
                        ...
                        ('zAsset-Adjustment Timestamp - datetime-201',  'datetime'),
                        ('zUnmAdj-Adjustment Timestamp - datetime-202',  'datetime'),
                        ('zCompSyncAttr-Cloud_Compute_State_Last_Updated_Date - datetime-203',  'datetime'),
                        ...
                        ('zMedAnlyAstAttr-Media Analysis Timestamp - datetime-227',  'datetime'),
                        ('zAsset-Analysis State Modificaion Date - datetime-228',  'datetime'),
                        ...
                        ('zAddAssetAttr-Scene Analysis Timestamp - datetime-238',  'datetime'),
                        ...
                        'zAsset-Current_Sleet_Cast-253',
                        'zAddAssetAttr.Sleet_Is_Reversible-254',
                        ...
                        ('zPhotoAnalysisAssetAttr-Wallpaper Properties Timestamp - datetime-308',  'datetime'),
                        'zPhotoAnalysisAssetAttr-Wallpaper Properties Data-309',
                        ('zCldFeedEnt-Entry Date - datetime-310',  'datetime'),
                        'zCldFeedEnt-Entry_Is_Mine-311',
                        ...
                        'zCldFeedEnt-Entry Type-316',
                        'zCldSharedComment-Cloud GUID-4TableStart-317',
                        ('zCldSharedComment-Date - datetime-318',  'datetime'),
                        ('zCldSharedComment-Comment Client Date - datetime-319',  'datetime'),
                        ('zAsset-Cloud Last Viewed Comment Date - datetime-320',  'datetime'),
                        ...
                        'zSharePartic-z66SHARE-340',
                        'SPLzSharePartic-z66SHARE-341',
                        ...
                        'zShare-Allows Access Requests-CMM-350',
                        'SPLzShare-Allows Access Requests-SPL-351',
                        'zShare-CollectionShare CurrentUser ContribState-CMM-352',
                        'SPLzShare-CollectionShare CurrentUser ContribState-SPL-353',
                        'zShare-CollectionShare ExpiringState-CMM-354',
                        'SPLzShare-CollectionShare ExpiringState-SPL-355',
                        'zShare-CollectionShare Kind-CMM-356',
                        'SPLzShare-CollectionShare Kind-SPL-357',
                        'zShare-Creation Type-CMM-358',
                        'SPLzShare-Creation Type-SPL-359',
                        ...
                        'zShare-Client BundleID-CMM-368',
                        'SPLzShare-Client BundleID-SPL-369',
                        ('zShare-Creation Date-CMM - datetime-370',  'datetime'),
                        ('SPLzShare-Creation Date-SPL - datetime-371',  'datetime'),
                        ('zShare-Start Date-CMM - datetime-372',  'datetime'),
                        ('SPLzShare-Start Date-SPL - datetime-373',  'datetime'),
                        ('zShare-Cloud Subscription Date-CMM- 4zShare - datetime-374',  'datetime'),
                        ('SPLzShare-Cloud Subscription Date-SPL- 4zShare - datetime-375',  'datetime'),
                        ('zShare-End Date-CMM - datetime-376',  'datetime'),
                        ('SPLzShare-End Date-SPL - datetime-377',  'datetime'),
                        ('zShare-Expiry Date-CMM - datetime-378',  'datetime'),
                        ('SPLzShare-Expiry Date-SPL - datetime-379',  'datetime'),
                        ('zShare-Last Modified Date-CMM - datetime-380',  'datetime'),
                        ('SPLzShare-Last Modified Date-SPL - datetime-381',  'datetime'),
                        'zShare-Cloud Item Count-CMM-382',
                        'SPLzShare-Cloud Item Count-SPL-383',
                        'zShare-Asset Count-CMM-384',
                        'SPLzShare-Asset Count-SPL-385',
                        'zShare-Cloud Photo Count-CMM-386',
                        'SPLzShare-Cloud Photo Count-SPL-387',
                        'zShare-CountOfAssets AddedByCamera Smart Sharing-HomeShare-CMM-388',
                        'SPLzShare-CountOfAssets AddedByCamera Smart Sharing-HomeShare-SPL-389',
                        'zShare-Photos Count-CMM-390',
                        'SPLzShare-Photos Count-CMM-SPL-391',
                        'zShare-Cloud Video Count-CMM-392',
                        'SPLzShare-Cloud Video Count-SPL-393',
                        'zShare-Videos Count-CMM-394',
                        'SPLzShare-Videos Count-SPL-395',
                        'zShare-Unseen Assets Count-CMM-396',
                        'SPLzShare-Unseen Assets Count-SPL-397',
                        'zShare-Unseen Content State-CMM-398',
                        'SPLzShare-Unseen Content State-SPL-399',
                        'zShare-Force Sync Attempted-CMM-400',
                        'SPLzShare-Force Sync Attempted-SPL-401',
                        'zShare-Cloud Local State-CMM-402',
                        'SPLzShare-Cloud Local State-SPL-403',
                        'zShare-Scope Syncing State-CMM-404',
                        'SPLzShare-Scope Syncing State-SPL-405',
                        'zShare-Scope Syncing State1-CMM-406',
                        'SPLzShare-Scope Syncing State1-SPL-407',
                        'zShare-Auto Share Policy-CMM-408',
                        'SPLzShare-Auto Share Policy-SPL-409',
                        'zShare-Should Notify On Upload Completion-CMM-410',
                        'SPLzShare-Should Notify On Upload Completion-SPL-411',
                        'zAsset-Trashed by Participant= zSharePartic_zPK-SPL-CMM-412',
                        'zShare-Trashed State-CMM-413',
                        'SPLzShare-Trashed State-SPL-414',
                        'zShare-Cloud Delete State-CMM-415',
                        'SPLzShare-Cloud Delete State-SPL-416',
                        ('zShare-Trashed Date-CMM - datetime-417',  'datetime'),
                        ('SPLzShare-Trashed Date-SPL - datetime-418',  'datetime'),
                        ('zShare-LastParticipant Asset Trash Notification Date-CMM - datetime-419',  'datetime'),
                        ('SPLzShare-LastParticipant Asset Trash Notification Date-SPL - datetime-420',  'datetime'),
                        ('zShare-Last Participant Asset Trash Notification View Date-CMM - datetime-421',  'datetime'),
                        ('SPLzShare-Last Participant Asset Trash Notification View Date-SPL - datetime-422',  'datetime'),
                        'zShare-Exit Source-CMM-423',
                        'SPLzShare-Exit Source-SPL-424',
                        'zShare-SPL_Exit State-CMM-425',
                        'SPLzShare-SPL_Exit State-SPL-426',
                        'zShare-Exit Type-CMM-427',
                        'SPLzShare-Exit Type-SPL-428',
                        'zShare-Should Ignor Budgets-CMM-429',
                        'SPLzShare-Should Ignor Budgets-SPL-430',
                        'zShare-Preview State-CMM-431',
                        'SPLzShare-Preview State-SPL-432',
                        'zShare-Phone Invitation Token-CMM-433',
                        'SPLzShare-Phone Invitation Token-SPL-434',
                        'zShare-CK Share Data-CMM-435',
                        'SPLzShare-CK Share Data-SPL-436',
                        'zShare-Preview Data-CMM-437',
                        'SPLzShare-Preview Data-SPL-438',
                        'zShare-Rules-CMM-439',
                        'SPLzShare-Rules-SPL-440',
                        'zShare-Thumbnail Image Data-CMM-441',
                        'SPLzShare-Thumbnail Image Data-SPL-442',
                        'zShare-Participant Cloud Update State-CMM-443',
                        'SPLzShare-Participant Cloud Update State-SPL-444',
                        'zSharePartic-UUID-4TableStart-445',
                        'SPLzSharePartic-UUID-4TableStart-446',
                        'zSharePartic-Acceptance Status-447',
                        'SPLzSharePartic-Acceptance Status-448',
                        'zSharePartic-Is Current User-449',
                        'SPLzSharePartic-Is Current User-450',
                        'zSharePartic-Role-451',
                        'SPLzSharePartic-Role-452',
                        'zSharePartic-Premission-453',
                        'SPLzSharePartic-Premission-454',
                        'zSharePartic-Participant ID-455',
                        'SPLzSharePartic-Participant ID-456',
                        'zSharePartic-User ID-457',
                        'SPLzSharePartic-User ID-458',
                        'zAsstContrib-Participant= zSharePartic-zPK-4TableStart-459',
                        'SPLzSharePartic-zPK-4TableStart-460',
                        'zSharePartic-zPK-4TableStart-461',
                        'zSharePartic-Email Address-462',
                        'SPLzSharePartic-Email Address-463',
                        'zSharePartic-Phone Number-464',
                        'SPLzSharePartic-Phone Number-465',
                        'zSharePartic-Name Components-466',
                        'SPLzSharePartic-Name Components-467',
                        'zSharePartic-Exit State-468',
                        'SPLzSharePartic-Exit State-469',
                        'ParentzGenAlbum-UUID-4TableStart-470',
                        'zGenAlbum-UUID-4TableStart-471',
                        'SWYConverszGenAlbum-UUID-4TableStart-472',
                        'ParentzGenAlbum-Cloud GUID-4TableStart-473',
                        'zGenAlbum-Cloud GUID-4TableStart-474',
                        'SWYConverszGenAlbum-Cloud GUID-4TableStart-475',
                        'zCldShareAlbumInvRec-Album GUID-4TableStart-476',
                        'zCldShareAlbumInvRec-Cloud GUID-4TableStart-477',
                        'zGenAlbum-Project Render UUID-4TableStart-478',
                        'SWYConverszGenAlbum-Project Render UUID-4TableStart-479',
                        'zAlbumList-Needs Reordering Number-480',
                        'zGenAlbum-zENT- Entity-481',
                        'ParentzGenAlbum-Kind-482',
                        'zGenAlbum-Album Kind-483',
                        'SWYConverszGenAlbum-Album Kind-484',
                        'ParentzGenAlbum-Cloud-Local-State-485',
                        'zGenAlbum-Cloud_Local_State-486',
                        'SWYConverszGenAlbum-Cloud_Local_State-487',
                        'ParentzGenAlbum- Title-488',
                        'zGenAlbum- Title-User&System Applied-489',
                        'SWYConverszGenAlbum- Title -User&System Applied-490',
                        'zGenAlbum-Import Session ID-SWY-491',
                        'zAsset- Conversation= zGenAlbum_zPK-492',
                        'SWYConverszGenAlbum- Import Session ID-SWY-493',
                        'zGenAlbum-Imported by Bundle Identifier-494',
                        'SWYzGenAlbum-Imported by Bundle Identifier-495',
                        'SWYConverszGenAlbum- Syndicate-496',
                        ('ParentzGenAlbum-Creation Date - datetime-497',  'datetime'),
                        ('zGenAlbum-Creation Date - datetime-498',  'datetime'),
                        ('SWYConverszGenAlbum-Creation Date - datetime-499',  'datetime'),
                        ('zGenAlbum-Cloud Creation Date - datetime-500',  'datetime'),
                        ('SWYConverszGenAlbum-Cloud Creation Date - datetime-501',  'datetime'),
                        ('zGenAlbum-Start Date - datetime-502',  'datetime'),
                        ('SWYConverszGenAlbum-Start Date - datetime-503',  'datetime'),
                        ('zGenAlbum-End Date - datetime-504',  'datetime'),
                        ('SWYConverszGenAlbum-End Date - datetime-505',  'datetime'),
                        ('zGenAlbum-Cloud Subscription Date - datetime-506',  'datetime'),
                        ('SWYConverszGenAlbum-Cloud Subscription Date - datetime-507',  'datetime'),
                        ('zShare-Cloud Subscription Date-CMM - datetime-508',  'datetime'),
                        ('SPLzShare-Cloud Subscription Date-SPL - datetime-509',  'datetime'),
                        'zGenAlbum-Cloud Metadata-HEX NSKeyed Plist-510',
                        'SWYConverszGenAlbum-Cloud Metadata-HEX NSKeyed Plist-511',
                        'ParentzGenAlbum-Pending Items Count-512',
                        'zGenAlbum-Pending Items Count-513',
                        'SWYConverszGenAlbum-Pending Items Count-514',
                        'ParentzGenAlbum-Pending Items Type-515',
                        'zGenAlbum-Pending Items Type-516',
                        'SWYConverszGenAlbum-Pending Items Type-517',
                        'zGenAlbum- Cached Photos Count-518',
                        'SWYConverszGenAlbum- Cached Photos Count-519',
                        'zGenAlbum- Cached Videos Count-520',
                        'SWYConverszGenAlbum- Cached Videos Count-521',
                        'zGenAlbum- Cached Count-522',
                        'SWYConverszGenAlbum- Cached Count-523',
                        'ParentzGenAlbum-Sync Event Order Key-524',
                        'zGenAlbum-Sync Event Order Key-525',
                        'SWYConverszGenAlbum-Sync Event Order Key-526',
                        'zGenAlbum-Has Unseen Content-527',
                        'SWYConverszGenAlbum-Has Unseen Content-528',
                        'zGenAlbum-Unseen Asset Count-529',
                        'SWYConverszGenAlbum-Unseen Asset Count-530',
                        'zGenAlbum-is Owned-531',
                        'SWYConverszGenAlbum-is Owned-532',
                        'zGenAlbum-Cloud Relationship State-533',
                        'SWYConverszGenAlbum-Cloud Relationship State-534',
                        'zGenAlbum-Cloud Relationship State Local-535',
                        'SWYConverszGenAlbum-Cloud Relationship State Local-536',
                        'zGenAlbum-Cloud Owner Mail Key-537',
                        'SWYConverszGenAlbum-Cloud Owner Mail Key-538',
                        'zGenAlbum-Cloud Owner Frist Name-539',
                        'SWYConverszGenAlbum-Cloud Owner Frist Name-540',
                        'zGenAlbum-Cloud Owner Last Name-541',
                        'SWYConverszGenAlbum-Cloud Owner Last Name-542',
                        'zGenAlbum-Cloud Owner Full Name-543',
                        'SWYConverszGenAlbum-Cloud Owner Full Name-544',
                        'zGenAlbum-Cloud Person ID-545',
                        'SWYConverszGenAlbum-Cloud Person ID-546',
                        'zShare-Cloud Person ID-CMM-547',
                        'SPLzShare-Cloud Person ID-SPL-548',
                        'zAsset-Cloud Owner Hashed Person ID-549',
                        'zGenAlbum-Cloud Owner Hashed Person ID-550',
                        'SWYConverszGenAlbum-Cloud Owner Hashed Person ID-551',
                        'zGenAlbum-Local Cloud Multi-Contributors Enabled-552',
                        'SWYConverszGenAlbum-Local Cloud Multi-Contributors Enabled-553',
                        'zGenAlbum-Cloud Multi-Contributors Enabled-554',
                        'SWYConverszGenAlbum-Cloud Multi-Contributors Enabled-555',
                        'zGenAlbum-Cloud Album Sub Type-556',
                        'SWYConverszGenAlbum-Cloud Album Sub Type-557',
                        ('zGenAlbum-Cloud Contribution Date - datetime-558',  'datetime'),
                        ('SWYConverszGenAlbum-Cloud Contribution Date - datetime-559',  'datetime'),
                        ('zGenAlbum-Cloud Last Interesting Change Date - datetime-560',  'datetime'),
                        ('SWYConverszGenAlbum-Cloud Last Interesting Change Date - datetime-561',  'datetime'),
                        'zGenAlbum-Cloud Notification Enabled-562',
                        'SWYConverszGenAlbum-Cloud Notification Enabled-563',
                        'ParentzGenAlbum-Pinned-564',
                        'zGenAlbum-Pinned-565',
                        'SWYConverszGenAlbum-Pinned-566',
                        'ParentzGenAlbum-Custom Sort Key-567',
                        'zGenAlbum-Custom Sort Key-568',
                        'SWYConverszGenAlbum-Custom Sort Key-569',
                        'ParentzGenAlbum-Custom Sort Ascending-570',
                        'zGenAlbum-Custom Sort Ascending-571',
                        'SWYConverszGenAlbum-Custom Sort Ascending-572',
                        'ParentzGenAlbum-Is Prototype-573',
                        'zGenAlbum-Is Prototype-574',
                        'SWYConverszGenAlbum-Is Prototype-575',
                        'ParentzGenAlbum-Project Document Type-576',
                        'zGenAlbum-Project Document Type-577',
                        'SWYConverszGenAlbum-Project Document Type-578',
                        'ParentzGenAlbum-Custom Query Type-579',
                        'zGenAlbum-Custom Query Type-580',
                        'SWYConverszGenAlbum-Custom Query Type-581',
                        'ParentzGenAlbum-Trashed State-582',
                        ('ParentzGenAlbum-Trash Date - datetime-583',  'datetime'),
                        'zGenAlbum-Trashed State-584',
                        ('zGenAlbum-Trash Date - datetime-585',  'datetime'),
                        'SWYConverszGenAlbum-Trashed State-586',
                        ('SWYConverszGenAlbum-Trash Date - datetime-587',  'datetime'),
                        'ParentzGenAlbum-Cloud Delete State-588',
                        'zGenAlbum-Cloud Delete State-589',
                        'SWYConverszGenAlbum-Cloud Delete State-590',
                        'zGenAlbum-Cloud Owner Whitelisted-591',
                        'SWYConverszGenAlbum-Cloud Owner Whitelisted-592',
                        'zGenAlbum-Cloud Local Public URL Enabled-593',
                        'SWYConverszGenAlbum-Cloud Local Public URL Enabled-594',
                        'zGenAlbum-Cloud Public URL Enabled-595',
                        'zGenAlbum-Public URL-596',
                        'SWYConverszGenAlbum-Cloud Public URL Enabled-597',
                        'SWYConverszGenAlbum-Public URL-598',
                        'zGenAlbum-Key Asset Face Thumb Index-599',
                        'SWYConverszGenAlbum-Key Asset Face Thumb Index-600',
                        'zGenAlbum-Project Text Extension ID-601',
                        'SWYConverszGenAlbum-Project Text Extension ID-602',
                        'zGenAlbum-User Query Data-603',
                        'SWYConverszGenAlbum-User Query Data-604',
                        'zGenAlbum-Custom Query Parameters-605',
                        'SWYConverszGenAlbum-Custom Query Parameters-606',
                        'zGenAlbum-Project Data-607',
                        'SWYConverszGenAlbum-Project Data-608',
                        'zGenAlbum-Search Index Rebuild State-609',
                        'SWYConverszGenAlbum-Search Index Rebuild State-610',
                        'zGenAlbum-Duplicate Type-611',
                        'SWYConverszGenAlbum-Duplicate Type-612',
                        'zGenAlbum-Privacy State-613',
                        'SWYConverszGenAlbum-Privacy State-614',
                        'zCldShareAlbumInvRec-zUUID-4TableStart-615',
                        'zCldShareAlbumInvRec-Is My Invitation to Shared Album-616',
                        'zCldShareAlbumInvRec-Invitation State Local-617',
                        'zCldShareAlbumInvRec-Invitation State-Shared Album Invite Status-618',
                        ('zCldShareAlbumInvRec-Subscription Date - datetime-619',  'datetime'),
                        'zCldShareAlbumInvRec-Invitee First Name-620',
                        'zCldShareAlbumInvRec-Invitee Last Name-621',
                        'zCldShareAlbumInvRec-Invitee Full Name-622',
                        'zCldShareAlbumInvRec-Invitee Hashed Person ID-623',
                        'zCldShareAlbumInvRec-Invitee Email Key-624',
                        'zGenAlbum-Key Asset Face ID-625',
                        'zFaceCrop-Face Area Points-626',
                        'zAddAssetAttr.Has_People_Scene Mid_Or_Greater_Confidence-627',
                        'zAsset-Face Adjustment Version-628',
                        'zAddAssetAttr-Face Regions HEX-629',
                        'zAddAssetAttr-Face Analysis Version-630',
                        'zDetFace-Asset Visible-631',
                        'zDetFacePrint-Data HEX-632',
                        'zPerson-Contact Matching Dictionary HEX-633',
                        'zPerson-Face Count-634',
                        'zDetFace-Face Crop-635',
                        'zDetFace-Face Algorithm Version-636',
                        'zDetFace-Adjustment Version-637',
                        'zDetFace-UUID-4TableStart-638',
                        'zPerson-Person UUID-4TableStart-639',
                        'zPerson-Is_Me_Confidence-4TableStart-640',
                        'zPerson - MD ID-641',
                        'zPerson - Asset Sort Order-642',
                        'zDetFace-Confirmed Face Crop Generation State-643',
                        'zDetFace-Manual-644',
                        'zDetFace-Detection Type-645',
                        'zPerson-Detection Type-646',
                        'zDetFace-VIP Model Type-647',
                        'zDetFace-Name Source-648',
                        'zDetFace-Cloud Name Source-649',
                        'zPerson-Merge Candidate Confidence-650',
                        'zPerson-Person URI-651',
                        'zPerson-Display Name-652',
                        'zPerson-Full Name-653',
                        'zPerson-Cloud Verified Type-654',
                        'zFaceCrop-State-655',
                        'zFaceCrop-Type-656',
                        'zFaceCrop-Resource Data-HEX-PHOTO used for FaceCrop-657',
                        'zFaceCrop-UUID-4TableStart-658',
                        'zPerson-Type-659',
                        'zPerson-Verified Type-660',
                        'zPerson-Gender Type-661',
                        'zDetFace-Gender Type-662',
                        'zDetFace-Center X-663',
                        'zDetFace-Center Y-664',
                        'zPerson-Age Type Estimate-665',
                        'zDetFace-Age Type Estimate-666',
                        'zDetFace-Ethnicity Type-667',
                        'zDetFace-Skin Tone Type-668',
                        'zDetFace-Hair Type-669',
                        'zDetFace-Hair Color Type-670',
                        'zDetFace-Head Gear Type-671',
                        'zDetFace-Facial Hair Type-672',
                        'zDetFace-Has Face Mask-673',
                        'zDetFace-Pose Type-674',
                        'zDetFace-Face Expression Type-675',
                        'zDetFace-Has Smile-676',
                        'zDetFace-Smile Type-677',
                        'zDetFace-Lip Makeup Type-678',
                        'zDetFace-Eyes State-679',
                        'zDetFace-Is Left Eye Closed-680',
                        'zDetFace-Is Right Eye Closed-681',
                        'zDetFace-Gaze Center X-682',
                        'zDetFace-Gaze Center Y-683',
                        'zDetFace-Face Gaze Type-684',
                        'zDetFace-Eye Glasses Type-685',
                        'zDetFace-Eye Makeup Type-686',
                        'zDetFace-Cluster Squence Number Key-687',
                        'zDetFace-Grouping ID-688',
                        'zDetFace-Master ID-689',
                        'zDetFace-Quality-690',
                        'zDetFace-Quality Measure-691',
                        'zDetFace-Source Height-692',
                        'zDetFace-Source Width-693',
                        'zDetFace-Hidden-Asset Hidden-694',
                        'zDetFace-In Trash-Recently Deleted-695',
                        'zDetFace-Cloud Local State-696',
                        'zDetFace-Training Type-697',
                        'zDetFace.Pose Yaw-698',
                        'zDetFace-Body Center X-699',
                        'zDetFace-Body Center Y-700',
                        'zDetFace-Body Height-701',
                        'zDetFace-Body Width-702',
                        'zDetFace-Roll-703',
                        'zDetFace-Size-704',
                        'zDetFace-Cluster Squence Number-705',
                        'zDetFace-Blur Score-706',
                        'zDetFacePrint-Face Print Version-707',
                        'zMedAnlyAstAttr-Face Count-708',
                        'zDetFaceGroup-UUID-4TableStart-709',
                        'zDetFaceGroup-Person Builder State-710',
                        'zDetFaceGroup-UnNamed Face Count-711',
                        'zPerson-In Person Naming Model-712',
                        'zPerson-Key Face Pick Source Key-713',
                        'zPerson-Manual Order Key-714',
                        'zPerson-Question Type-715',
                        'zPerson-Suggested For Client Type-716',
                        'zPerson-Merge Target Person-717',
                        'zPerson-Cloud Local State-718',
                        'zFaceCrop-Cloud Local State-719',
                        'zFaceCrop-Cloud Type-720',
                        'zPerson-Cloud Delete State-721',
                        'zFaceCrop-Cloud Delete State-722',
                        'zFaceCrop-Invalid Merge Canidate Person UUID-4TableStart-723',
                        'zAsset-Highlight Visibility Score-724',
                        'zMemory-UUID-4TableStart-725',
                        'zMemory-AssetListPredicte-726',
                        'zMemory-Score-727',
                        'zMemory-SubTitle-728',
                        'zMemory-Title-729',
                        'zMemory-Category-730',
                        'zMemory-SubCategory-731',
                        ('zMemory-Creation Date - datetime-732',  'datetime'),
                        ('zMemory-Last Enrichment Date - datetime-733',  'datetime'),
                        'zMemory-User Action Options-734',
                        'zMemory-Favorite Memory-735',
                        'zMemory-View Count-736',
                        'zMemory-Play Count-737',
                        'zMemory-Rejected-738',
                        'zMemory-Share Count-739',
                        'zMemory-Sharing Composition-740',
                        'zMemory-PhotosGraphData-HEX NSKeyed Plist-741',
                        'zMemory-MovieAssetState-HEX NSKeyed Plist-742',
                        'zMemory-MovieData-HEX NSKeyed Plist-743',
                        ('zMemory-Last Movie Play Date - datetime-744',  'datetime'),
                        ('zMemory-Last Viewed Date - datetime-745',  'datetime'),
                        'zMemory-Pending Play Count Memory-746',
                        'zMemory-Pending Share Count Memory-747',
                        'zMemory-Pending View Count Memory-748',
                        'zMemory-Pending State-749',
                        'zMemory-Featured State-750',
                        'zMemory-Photos Graph Version-751',
                        'zMemory-Graph Memory Identifier-752',
                        'zMemory-Notification State-753',
                        'zMemory-Cloud Local State-754',
                        'zMemory-Cloud Delete State-755',
                        'zMemory-Story Color Grade Kind-756',
                        'zMemory-Story Serialized Title Category-757',
                        'zMemory-Syndicated Content State-758',
                        'zMemory-Search Index Rebuild State-759',
                        'zMemory-Black Listed Feature-760',
                        'zMoment-UUID-4TableStart-761',
                        'zMoment-Aggregation Score-762',
                        ('zMoment-Start Date - datetime-763',  'datetime'),
                        ('zMoment-Representative Date - datetime-764',  'datetime'),
                        'zMoment-Timezone Offset-765',
                        ('zMoment-Modification Date - datetime-766',  'datetime'),
                        ('zMoment-End Date - datetime-767',  'datetime'),
                        'zMoment-SubTitle-768',
                        'zMoment-Localized Location Names-769',
                        'zMoment-Title-770',
                        'zMoment-Originator State-771',
                        'zMoment-Sharing Composition-772',
                        'zMoment-Cached Count Shared-773',
                        'zMoment-Processed Location-774',
                        'zMoment-Approx Latitude-775',
                        'zMoment-Approx Longitude-776',
                        'zMoment-GPS Horizontal Accuracy-777',
                        'zMoment-Cache Count-778',
                        'zMoment-Cached Photos Count-779',
                        'zMoment-Cached Videos Count-780',
                        'zMoment-Trashed State-781',
                        'SBKAzSugg-UUID-4TableStart-782',
                        'SBKAzSugg-Suggestion Context-783',
                        'SBKAzSugg-Sharing Composition-784',
                        ('SBKAzSugg-Start Date - datetime-785',  'datetime'),
                        'SBKAzSugg-State-786',
                        'SBKAzSugg-Featured State-787',
                        'SBKAzSugg- Available Features-788',
                        'SBKAzSugg-Notification State-789',
                        ('SBKAzSugg-Creation Date - datetime-790',  'datetime'),
                        ('SBKAzSugg-End Date - datetime-791',  'datetime'),
                        ('SBKAzSugg-Activation Date - datetime-792',  'datetime'),
                        ('SBKAzSugg-Expunge Date - datetime-793',  'datetime'),
                        ('SBKAzSugg-Relevant Until Date - datetime-794',  'datetime'),
                        'SBKAzSugg-Title-795',
                        'SBKAzSugg-Sub Title-796',
                        'SBKAzSugg-Cached Count-797',
                        'SBKAzSugg-Cahed Photos Count-798',
                        'SBKAzSugg-Cached Videos Count-799',
                        'SBKAzSugg-Type-800',
                        'SBKAzSugg-Sub Type-801',
                        'SBKAzSugg-Action Data-802',
                        'SBKAzSugg-Features Data-DeviceInfo HEX NSKeyed Plist-803',
                        'SBKAzSugg-Version-804',
                        'SBKAzSugg-Cloud Local State-805',
                        'SBKAzSugg-Cloud Delete State-806',
                        'SBRAzSugg-UUID-4TableStart-807',
                        'SBRAzSugg-Suggestion Context-808',
                        'SBRAzSugg-Sharing Composition-809',
                        ('SBRAzSugg-Start Date - datetime-810',  'datetime'),
                        'SBRAzSugg-State-811',
                        'SBRAzSugg-Featured State-812',
                        'SBRAzSugg- Available Features-813',
                        'SBRAzSugg-Notification State-814',
                        ('SBRAzSugg-Creation Date - datetime-815',  'datetime'),
                        ('SBRAzSugg-End Date - datetime-816',  'datetime'),
                        ('SBRAzSugg-Activation Date - datetime-817',  'datetime'),
                        ('SBRAzSugg-Expunge Date - datetime-818',  'datetime'),
                        ('SBRAzSugg-Relevant Until Date - datetime-819',  'datetime'),
                        'SBRAzSugg-Title-820',
                        'SBRAzSugg-Sub Title-821',
                        'SBRAzSugg-Cached Count-822',
                        'SBRAzSugg-Cahed Photos Count-823',
                        'SBRAzSugg-Cached Videos Count-824',
                        'SBRAzSugg-Type-825',
                        'SBRAzSugg-Sub Type-826',
                        'SBRAzSugg-Action Data-827',
                        'SBRAzSugg-Features Data-DeviceInfo HEX NSKeyed Plist-828',
                        'SBRAzSugg-Version-829',
                        'SBRAzSugg-Cloud Local State-830',
                        'SBRAzSugg-Cloud Delete State-831',
                        'zMedAnlyAstAttr-Media Analysis Version-832',
                        'zMedAnlyAstAttr-Audio Classification-833',
                        'zMedAnlyAstAttr-Best Video Range Duration Time Scale-834',
                        'zMedAnlyAstAttr-Best Video Range Start Time Scale-835',
                        'zMedAnlyAstAttr-Best Video Range Duration Value-836',
                        'zMedAnlyAstAttr-Best Video Range Start Value-837',
                        'zMedAnlyAstAttr-Packed Best Playback Rect-838',
                        'zMedAnlyAstAttr-Activity Score-839',
                        'zMedAnlyAstAttr-Video Score-840',
                        'zMedAnlyAstAttr-Audio Score-841',
                        'zMedAnlyAstAttr-Wallpaper Score-842',
                        'zMedAnlyAstAttr-AutoPlay Suggestion Score-843',
                        'zMedAnlyAstAttr-Blurriness Score-844',
                        'zMedAnlyAstAttr-Exposure Score-845',
                        'zMedAnlyAstAttr-Probable Rotation Direction Confidence-846',
                        'zMedAnlyAstAttr-Probable Rotation Direction-847',
                        'zMedAnlyAstAttr-Screen Time Device Image Sensitivity-848',
                        'zMedAnlyAstAttr-Color Normalization Data-849',
                        'zMedAnlyAstAttr-Media_Analysis Image_Version-850',
                        'zMedAnlyAstAttr-Image_Caption_Version-851',
                        'zMedAnlyAstAttr-Video_Caption_Version-852',
                        'zMedAnlyAstAttr-VA_Location_Analysis_Version-853',
                        'zAssetAnalyState-Asset UUID-4TableStart-854',
                        'zAssetAnalyState-Analyisis State-855',
                        'zAssetAnalyState-Worker Flags-856',
                        'zAssetAnalyState-Worker Type-857',
                        ('zAssetAnalyState-Ignore Until Date - datetime-858',  'datetime'),
                        ('zAssetAnalyState-Last Ignored Date - datetime-859',  'datetime'),
                        'zAssetAnalyState-Sort Token-860',
                        'zMedAnlyAstAttr-Character Recognition Attr-861',
                        'zCharRecogAttr-Algorithm Version-862',
                        'zCharRecogAttr-Adjustment Version-863',
                        'zCharRecogAttr-Character Recogition Data-HEX-864',
                        'zCharRecogAttr-Machine Readable Code Data-HEX-865',
                        'zMedAnlyAstAttr-Visual Search Attributes-866',
                        'zVisualSearchAttr-Algorithm Version-867',
                        'zVisualSearchAttr-Adjustment Version-868',
                        'zVisualSearchAttr-Visual Search Data-HEX-869',
                        'zVisualSearchAttr - Sticker Confidence Algorithm Version-870',
                        'zVisualSearchAttr - Sticker Confidence Score-871',
                        'zAsset-Sticker Confidence Score-872',
                        'zAsset-Overall Aesthetic Score-873',
                        'zCompAssetAttr-Failure Score zCompAssetAttr-874',
                        'zCompAssetAttr-Harmonious Color Score-875',
                        'zCompAssetAttr-Immersiveness Score-876',
                        'zCompAssetAttr-Intersting Subject Score-877',
                        'zCompAssetAttr-Intrusive Object Presence Score-878',
                        'zCompAssetAttr-Lively Color Score-879',
                        'zCompAssetAttr-Low Light-880',
                        'zCompAssetAttr-Noise Score-881',
                        'zCompAssetAttr-Pleasant Camera Tilt Score-882',
                        'zCompAssetAttr-Pleasant Composition Score-883',
                        'zCompAssetAttr-Pleasant Lighting Score-884',
                        'zCompAssetAttr-Pleasant Pattern Score-885',
                        'zCompAssetAttr-Pleasant Perspective Score-886',
                        'zCompAssetAttr-Pleasant Post Processing Score-887',
                        'zCompAssetAttr-Pleasant Reflection Score-888',
                        'zCompAssetAttrPleasant Symmetry Score-889',
                        'zCompAssetAttr-Sharply Focused Subject Score-890',
                        'zCompAssetAttr-Tastfully Blurred Score-891',
                        'zCompAssetAttr-Well Chosen Subject Score-892',
                        'zCompAssetAttr-Well Framed Subject Score-893',
                        'zCompAssetAttr-Well Timeed Shot Score-894',
                        'zCldRes-Asset UUID-4TableStart-895',
                        'zCldRes-Cloud Local State-896',
                        'zCldRes-File Size-897',
                        'zCldRes-Height-898',
                        'zCldRes-Is Available-899',
                        'zCldRes-Is Locally Available-900',
                        'zCldRes-Prefetch Count-901',
                        'zCldRes-Source Type-902',
                        'zCldRes-Type-903',
                        'zCldRes-Width-904',
                        'zCldRes-Date Created-905',
                        'zCldRes-Last OnDemand Download Date-906',
                        'zCldRes-Last Prefetch Date-907',
                        'zCldRes-Prunedat-908',
                        'zCldRes-File Path-909',
                        'zCldRes-Fingerprint-910',
                        'zCldRes-Item ID-911',
                        'zCldRes-UniID-912',
                        'zUserFeedback-UUID-4TableStart-913',
                        'zUserFeedback-Feature-914',
                        'zUserFeedback-Type-915',
                        'zUserFeedback-Last Modified Date-916',
                        'zUserFeedback-Context-917',
                        'zUserFeedback-Cloud Local State-918',
                        'zUserFeedback-Cloud Delete State-919',
                        'zUserFeedback - Creation Type-920',
                        'zAddAssetAttr-zPK-921',
                        'zAddAssetAttr-zENT-922',
                        'ZAddAssetAttr-zOPT-923',
                        'zAddAssetAttr-zAsset= zAsset_zPK-924',
                        'zAddAssetAttr-UnmanAdjust Key= zUnmAdj.zPK-925',
                        'zAddAssetAttr-Original Stable Hash-4Queryend-926',
                        'zAddAssetAttr-Public Global UUID-927',
                        'zAddAssetAttr-Deferred Photo Identifier-928',
                        'zAddAssetAttr-Original Assets UUID-929',
                        'zAddAssetAttr-Import Session ID-930',
                        'zAddAssetAttr-Originating Asset Identifier-4endquery-931',
                        'zAddAssetAttr.Adjusted Stable Hash-4endquery-932',
                        'zAlbumList-zPK= Album List Key-933',
                        'zAlbumList-zENT-934',
                        'zAlbumList-zOPT-935',
                        'zAlbumList-ID Key-936',
                        'zAlbumList-UUID-937',
                        'zAsset-zPK-938',
                        'zAsset-zENT-939',
                        'zAsset-zOPT-940',
                        'zAsset-Master= zCldMast-zPK-941',
                        'zAsset-Extended Attributes= zExtAttr-zPK-942',
                        'zAsset-Import Session Key-943',
                        'zAsset-Trashed by Participant= zSharePartic_zPK-944',
                        'zAsset-Photo Analysis Attributes Key-945',
                        'zAsset-Cloud Feed Assets Entry= zCldFeedEnt.zPK-946',
                        'zAsset-FOK-Cloud Feed Asset Entry Key-947',
                        'zAsset-Moment Share Key= zShare-zPK-948',
                        'zAsset-zMoment Key= zMoment-zPK-949',
                        'zAsset-Computed Attributes Asset Key-950',
                        'zAsset-Highlight Being Assets-HBA Key-951',
                        'zAsset-Highlight Being Extended Assets-HBEA Key-952',
                        'zAsset-Highlight Being Key Asset Private-HBKAP Key-953',
                        'zAsset-Highlight Being Key Asset Shared-HBKAS Key-954',
                        'zAsset-Highligh Being Summary Assets-HBSA Key-955',
                        'zAsset-Day Group Highlight Being Assets-DGHBA Key-956',
                        'zAsset-Day Group Highlight Being Extended Assets-DGHBEA Key-957',
                        'zAsset-Day Group Highlight Being Key Asset Private-DGHBKAP Key-958',
                        'zAsset-Day Group Highlight Being Key Asset Shared-DGHBKAS Key-959',
                        'zAsset-Day Group Highlight Being Summary Assets-DGHBSA Key-960',
                        'zAsset-Month Highlight Being Key Asset Private-MHBKAP Key-961',
                        'zAsset-Month Highlight Being Key Asset Shared-MHBKAS Key-962',
                        'zAsset-Year Highlight Being Key Asset Private-YHBKAP Key-963',
                        'zAsset-Year Highlight Being Key Asset Shared-YHBKAS Key-964',
                        'zAsset-Promotion Score-965',
                        'zAsset-Iconic Score-966',
                        'zAsset-Media Analysis Attributes Key-967',
                        'zAsset-Media Group UUID-968',
                        'zAsset-UUID = store.cloudphotodb-969',
                        'zAsset-Cloud_Asset_GUID = store.cloudphotodb-970',
                        'zAsset.Cloud Collection GUID-971',
                        'zAsset-Avalanche UUID-972',
                        'zAssetAnalyState-zPK-973',
                        'zAssetAnalyState-zEnt-974',
                        'zAssetAnalyState-zOpt-975',
                        'zAssetAnalyState-Asset= zAsset-zPK-976',
                        'zAssetAnalyState-Asset UUID-977',
                        'zAsstContrib-zPK-978',
                        'zAsstContrib-zEnt-979',
                        'zAsstContrib-zOpt-980',
                        'zAsstContrib-3Library Scope Asset Contributors= zAssset-zPK-981',
                        'zAsstContrib-Participant= zSharePartic-zPK-982',
                        'zAssetDes-zPK-983',
                        'zAssetDes-zENT-984',
                        'zAssetDes-zOPT-985',
                        'zAssetDes-Asset Attributes Key= zAddAssetAttr-zPK-986',
                        'zEdIPTCAttr-Asset Attributes= zAddAssetAttr.zPK-987',
                        'zEdIPTCAttr-Action Advised-988',
                        'zEdIPTCAttr-Audio Duration-989',
                        'zEdIPTCAttr-Audio Outcue-990',
                        'zEdIPTCAttr-Audio Sampling Rate-991',
                        'zEdIPTCAttr-Audio Sampling Res-992',
                        'zEdIPTCAttr-Audion Type-993',
                        'zEdIPTCAttr-ByLine-994',
                        'zEdIPTCAttr-ByLine Title-995',
                        'zEdIPTCAttr-Caption-996',
                        'zEdIPTCAttr-Category-997',
                        'zEdIPTCAttr-CIADR City-998',
                        'zEdIPTCAttr-CIADR Ctry-999',
                        'zEdIPTCAttr-CIADR ExtAdr-1000',
                        'zEdIPTCAttr-CIADR PCode-1001',
                        'zEdIPTCAttr-CIADR Region-1002',
                        'zEdIPTCAttr-CiEmailWork-1003',
                        'zEdIPTCAttr-CiTeLWork-1004',
                        'zEdIPTCAttr-CiURLWork-1005',
                        'zEdIPTCAttr-City-1006',
                        'zEdIPTCAttr-Contact-1007',
                        'zEdIPTCAttr-Content LocationCode-1008',
                        'zEdIPTCAttr-Content LocationName-1009',
                        'zEdIPTCAttr-Copy Right Notice-1010',
                        'zEdIPTCAttr-Cntry Primary LocationCode-1011',
                        'zEdIPTCAttr-Cntry Primary LocationName-1012',
                        'zEdIPTCAttr-Creator ContactInfo-1013',
                        'zEdIPTCAttr-Credit-1014',
                        'zEdIPTCAttr-DateCreated-TEXT-1015',
                        'zEdIPTCAttr-Dig Creation Date - TEXT-1016',
                        'zEdIPTCAttr-Dig Creation Time - TEXT-1017',
                        'zEdIPTCAttr-Dig SourceType-1018',
                        'zEdIPTCAttr-EditStatus-1019',
                        'zEdIPTCAttr-EditorAL Update-1020',
                        'zEdIPTCAttr-Exp Date - TEXT-1021',
                        'zEdIPTCAttr-Exp Time - TEXT-1022',
                        'zEdIPTCAttr-Fixture ID-1023',
                        'zEdIPTCAttr-Headline-1024',
                        'zEdIPTCAttr-Image Orientation-1025',
                        'zEdIPTCAttr-Image Type-1026',
                        'zEdIPTCAttr-Keywords-1027',
                        'zEdIPTCAttr-Language ID-1028',
                        'zEdIPTCAttr-Obj Attr Reference-1029',
                        'zEdIPTCAttr-Obj Cycle-1030',
                        'zEdIPTCAttr-Obj Name-1031',
                        'zEdIPTCAttr-Obj Type Ref-1032',
                        'zEdIPTCAttr-Org Transmission Ref-1033',
                        'zEdIPTCAttr-Orginating Program-1034',
                        'zEdIPTCAttr-Program Version-1035',
                        'zEdIPTCAttr-Province State-1036',
                        'zEdIPTCAttr-RefDate - TEXT-1037',
                        'zEdIPTCAttr-RefNumber-1038',
                        'zEdIPTCAttr-RefService-1039',
                        'zEdIPTCAttr-Release Date - TEXT-1040',
                        'zEdIPTCAttr-Release Time - TEXT-1041',
                        'zEdIPTCAttr-Scene-1042',
                        'zEdIPTCAttr-Source-1043',
                        'zEdIPTCAttr-Spec Instructions-1044',
                        'zEdIPTCAttr-Star Rating-1045',
                        'zEdIPTCAttr-SubLocation-1046',
                        'zEdIPTCAttr-Subject Ref-1047',
                        'zEdIPTCAttr-Supplemental Category-1048',
                        'zEdIPTCAttr-Time Created - TEXT-1049',
                        'zEdIPTCAttr-Urgency-1050',
                        'zEdIPTCAttr-Usage Terms-1051',
                        'zEdIPTCAttr-Writer Editor-1052',
                        'zEdIPTCAttr-Data - BLOB-1053',
                        'zCharRecogAttr-zPK-1054',
                        'zCharRecogAttr-zENT-1055',
                        'zCharRecogAttr-zOPT-1056',
                        'zCharRecogAttr-MedAssetAttr= zMedAnlyAstAttr-zPK-1057',
                        'zCldFeedEnt-zPK= zCldShared keys-1058',
                        'zCldFeedEnt-zENT-1059',
                        'zCldFeedEnt-zOPT-1060',
                        'zCldFeedEnt-Album-GUID= zGenAlbum.zCloudGUID-1061',
                        'zCldFeedEnt-Entry Invitation Record GUID-1062',
                        'zCldFeedEnt-Entry Cloud Asset GUID-1063',
                        'zCldMast-zPK= zAsset-Master-1064',
                        'zCldMast-zENT-1065',
                        'zCldMast-zOPT-1066',
                        'zCldMast-Moment Share Key= zShare-zPK-1067',
                        'zCldMast-Cloud_Master_GUID = store.cloudphotodb-1068',
                        'zCldMast-Originating Asset ID-1069',
                        'zCldMast-Import Session ID- AirDrop-StillTesting-1070',
                        'CMzCldMastMedData-zENT-1071',
                        'CMzCldMastMedData-zOPT-1072',
                        'CMzCldMastMedData-CldMast= zCldMast-zPK-1073',
                        'AAAzCldMastMedData-zENT-1074',
                        'AAAzCldMastMedData-zOPT-1075',
                        'AAAzCldMastMedData-CldMast key-1076',
                        'AAAzCldMastMedData-AddAssetAttr= AddAssetAttr-zPK-1077',
                        'zCldRes-zPK-1078',
                        'zCldRes-zENT-1079',
                        'zCldRes-zOPT-1080',
                        'zCldRes-Asset= zAsset-zPK-1081',
                        'zCldRes-Cloud Master= zCldMast-zPK-1082',
                        'zCldRes-Asset UUID-1083',
                        'zCldShareAlbumInvRec-zPK-1084',
                        'zCldShareAlbumInvRec-zEnt-1085',
                        'zCldShareAlbumInvRec-zOpt-1086',
                        'zCldShareAlbumInvRec-Album Key-1087',
                        'zCldShareAlbumInvRec-FOK Album Key-1088',
                        'zCldShareAlbumInvRec-Album GUID-1089',
                        'zCldShareAlbumInvRec-zUUID-1090',
                        'zCldShareAlbumInvRec-Cloud GUID-1091',
                        'zCldSharedComment-zPK-1092',
                        'zCldSharedComment-zENT-1093',
                        'zCldSharedComment-zOPT-1094',
                        'zCldSharedComment-Commented Asset Key= zAsset-zPK-1095',
                        'zCldSharedComment-CldFeedCommentEntry= zCldFeedEnt.zPK-1096',
                        'zCldSharedComment-FOK-Cld-Feed-Comment-Entry-Key-1097',
                        'zCldSharedComment-Liked Asset Key= zAsset-zPK-1098',
                        'zCldSharedComment-CldFeedLikeCommentEntry Key-1099',
                        'zCldSharedComment-FOK-Cld-Feed-Like-Comment-Entry-Key-1100',
                        'zCldSharedComment-Cloud GUID-1101',
                        'zCompAssetAttr-zPK-1102',
                        'zCompAssetAttr-zEnt-1103',
                        'zCompAssetAttr-zOpt-1104',
                        'zCompAssetAttr-Asset Key-1105',
                        'zAsset-Compute_Sync_Attributes= zCompSyncAttr-zPK-1106',
                        'zCompSyncAttr-zPK= zAsset-zCompSyncAttr-1107',
                        'zCompSyncAttr-zAsset= zAsset-zPK-1108',
                        'zCompSyncAttr-zENT-1109',
                        'zCompSyncAttr-zOPT-1110',
                        'zDetFace-zPK-1111',
                        'zDetFace-zEnt-1112',
                        'zDetFace.zOpt-1113',
                        'zDetFace-AssetForFace= zAsset-zPK or Asset Containing Face-1114',
                        'zDetFace-PersonForFace= zPerson-zPK-1115',
                        'zDetFace-Person Being Key Face-1116',
                        'zDetFace-Face Print-1117',
                        'zDetFace-FaceGroupBeingKeyFace= zDetFaceGroup-zPK-1118',
                        'zDetFace-FaceGroup= zDetFaceGroup-zPK-1119',
                        'zDetFace-UUID-1120',
                        'zDetFaceGroup-zPK-1121',
                        'zDetFaceGroup-zENT-1122',
                        'zDetFaceGroup-zOPT-1123',
                        'zDetFaceGroup-AssocPerson= zPerson-zPK-1124',
                        'zDetFaceGroup-KeyFace= zDetFace-zPK-1125',
                        'zDetFaceGroup-UUID-1126',
                        'zDetFacePrint-zPK-1127',
                        'zDetFacePrint-zEnt-1128',
                        'zDetFacePrint-zOpt-1129',
                        'zDetFacePrint-Face Key-1130',
                        'zExtAttr-zPK= zAsset-zExtendedAttributes-1131',
                        'zExtAttr-zENT-1132',
                        'zExtAttr-zOPT-1133',
                        'zExtAttr-Asset Key-1134',
                        'zEdIPTCAttr-zPK-1135',
                        'zEdIPTCAttr-zENT-1136',
                        'zEdIPTCAttr-zOPT-1137',
                        'zFaceCrop-zPK-1138',
                        'zFaceCrop-zEnt-1139',
                        'zFaceCrop-zOpt-1140',
                        'zFaceCrop-Asset Key-1141',
                        'zFaceCrop-Invalid Merge Canidate Person UUID-1142',
                        'zFaceCrop-Person=zPerson-zPK&zDetFace-Person-Key-1143',
                        'zFaceCrop-Face Key-1144',
                        'zFaceCrop-UUID-1145',
                        'zGenAlbum-zPK=32AlbumLists= 32Albums-1146',
                        'zGenAlbum-zENT-1147',
                        'zGenAlbum-zOpt-1148',
                        'zGenAlbum-Custom Key Asset-1149',
                        'zGenAlbum-Parent Folder Key= zGenAlbum-zPK-1150',
                        'zGenAlbum-FOK Parent Folder-1151',
                        'zGenAlbum-zSyndicate-1152',
                        'zGenAlbum-UUID-1153',
                        'SWYConverszGenAlbum-UUID-1154',
                        'zGenAlbum-Cloud_GUID = store.cloudphotodb-1155',
                        'SWYConverszGenAlbum-Cloud GUID-1156',
                        'zGenAlbum-Project Render UUID-1157',
                        'SWYConverszGenAlbum-Project Render UUID-1158',
                        'zIntResou-zPK-1159',
                        'zIntResou-zENT-1160',
                        'zIntResou-zOPT-1161',
                        'zIntResou-Asset= zAsset_zPK-1162',
                        'zIntResou-Fingerprint-4Queryend-1163',
                        'zIntResou-Stable Hash-4Queryend-1164',
                        'zIntResou-Cloud Delete Asset UUID With Resource Type-1165',
                        'zMedAnlyAstAttr-zPK= zAddAssetAttr-Media Metadata-1166',
                        'zMedAnlyAstAttr-zEnt-1167',
                        'zMedAnlyAstAttr-zOpt-1168',
                        'zMedAnlyAstAttr-Asset= zAsset-zPK-1169',
                        'zMemory-zPK-1170',
                        'zMemory-zENT-1171',
                        'zMemory-zOPT-1172',
                        'zMemory-Key Asset= zAsset-zPK-1173',
                        'zMemory-UUID-1174',
                        'zMoment-zPK-1175',
                        'zMoment-zENT-1176',
                        'zMoment-zOPT-1177',
                        'zMoment-Highlight Key-1178',
                        'zMoment-UUID-1179',
                        'zPerson-zPK=zDetFace-Person-1180',
                        'zPerson-zEnt-1181',
                        'zPerson-zOpt-1182',
                        'zPerson-Share Participant= zSharePartic-zPK-1183',
                        'zPerson-KeyFace=zDetFace-zPK-1184',
                        'zPerson-Assoc Face Group Key-1185',
                        'zPerson-Person UUID-1186',
                        'zPerson-Is_Me_Confidence-1187',
                        'zPhotoAnalysisAssetAttr-zPK-1188',
                        'zPhotoAnalysisAssetAttr-zEnt-1189',
                        'zPhotoAnalysisAssetAttr-zOpt-1190',
                        'zPhotoAnalysisAssetAttr-zAsset = zAsset-zPK-1191',
                        'zSceneP-zPK-1192',
                        'zSceneP-zENT-1193',
                        'zSceneP-zOPT-1194',
                        'zShare-zPK-1195',
                        ...
                        'zShare-UUID-1198',
                        'SPLzShare-UUID-1199',
                        'zShare-Scope ID = store.cloudphotodb-1200',
                        'zSharePartic-zPK-1201',
                        'zSharePartic-zENT-1202',
                        'zSharePartic-zOPT-1203',
                        'zSharePartic-Share Key= zShare-zPK-1204',
                        'zSharePartic-Person= zPerson-zPK-1205',
                        'zSharePartic-UUID-1206',
                        'SBKAzSugg-zPK-1207',
                        'SBKAzSugg-zENT-1208',
                        'SBKAzSugg-zOPT-1209',
                        'SBKAzSugg-UUID-1210',
                        ...
                        'SBRAzSugg-zOPT-1213',
                        'SBRAzSugg-UUID-1214',
                        'z3SuggBRA-3RepAssets-1215',
                        'z3SuggBRA-71SuggBeingRepAssets-1216',
                        'z3SuggBKA-71SuggBeingKeyAssets= zSugg-zPK-1217',
                        'z3SuggBKA-3KeyAssets1= zAsset-zPK-1218',
                        'zUnmAdj-zPK=zAddAssetAttr.ZUnmanAdj Key-1219',
                        'zUnmAdj-zOPT-1220',
                        'zUnmAdj-zENT-1221',
                        'zUnmAdj-Asset Attributes= zAddAssetAttr.zPK-1222',
                        'zUnmAdj-UUID-1223',
                        'zUnmAdj-Other Adjustments Fingerprint-1224',
                        'zUnmAdj-Similar to Orig Adjustments Fingerprint-1225',
                        'zUserFeedback-zPK-1226',
                        'zUserFeedback-zENT-1227',
                        'zUserFeedback-zOPT-1228',
                        'zUserFeedback-Person= zPerson-zPK-1229',
                        'zUserFeedback-Memory= zMemory-zPK-1230',
                        'zUserFeedback-UUID-1231',
                        'zVisualSearchAttr-zPK-1232',
                        'zVisualSearchAttr-zENT-1233',
                        'zVisualSearchAttr-zOPT-1234',
                        'zVisualSearchAttr-MedAssetAttr= zMedAnlyAstAttr-zPK-1235',
                        'z32AlbumList-32Albums= zGenAlbum-zPK-1236',
                        'z32AlbumList-Album List Key-1237',
                        'z32AlbumList-FOK32Albums Key-1238',
                        'z33Assets-33Albums= zGenAlbum-zPK-1239',
                        'z33Assets-3Asset Key= zAsset-zPK in the Album-1240',
                        'z33Assets-FOK-3Assets= zAsset.Z_FOK_CLOUDFEEDASSETSENTRY-1241',
                        'z3MemoryBMCAs-3MovieCuratedAssets= zAsset-zPK-1242',
                        'z3MemoryBCAs-3CuratedAssets= zAsset-zPK-1243',
                        'z3MemoryBCAs-56memoriesBeingCuratedAssets= zMemory-zPK-1244',
                        'z3MemoryBECAs-3ExtCuratedAssets= zAsset-zPK-1245',
                        'z3MemoryBECAs-56MemoriesBeingExtCuratedAssets= zMemory-zPK-1246',
                        'z3MemoryBRAs-3RepresentativeAssets= zAsset-zPK-1247',
                        'z3MemoryBRAs-56RepresentativeAssets= zMemory-zPK-1248',
                        'z3MemoryBUCAs-3UserCuratedAssets= zAsset-zPK-1249',
                        'z3MemoryBUCAs-56MemoriesBeingUserCuratedAssets= zMemory-zPK-1250',
...
@artifact_processor
def Ph126_2iOS26RefforAssetAnalysisSyndPL(files_found, report_folder, seeker, wrap_text, timezone_offset):
	for source_path in files_found:
		source_path = str(source_path)
...
@artifact_processor
def Ph126_3iOS26RefforAssetAnalysisGenPlayPsql(files_found, report_folder, seeker, wrap_text, timezone_offset):
	for source_path in files_found:
		source_path = str(source_path)
	...
	iosversion = iOS.get_version()
	if (version.parse(iosversion) <= version.parse("18.7.8")) or (version.parse(iosversion) >= version.parse("27")):
		logfunc(f"Unsupported version for GenPlay-Photos.sqlite for iOS " + iosversion)
		return (), [], source_path
	if (version.parse(iosversion) >= version.parse("26")) & (version.parse(iosversion) < version.parse("27")):
		source_path = get_file_path(files_found, "Photos.sqlite")
		if source_path is None or not os.path.exists(source_path):
