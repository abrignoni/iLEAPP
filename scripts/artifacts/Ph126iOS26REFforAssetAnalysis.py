...
def Ph126_1iOS26RefforAssetAnalysisPhDaPsql(context):
    ...
    if (version.parse(iosversion) >= version.parse("26")) & (version.parse(iosversion) < version.parse("27")):
        ...
        SELECT 
          ...
          zEditedIPTCAttr.ZOBJECTTYPEREFERENCE AS 'zEdIPTCAttr-Obj Type Re',
          zEditedIPTCAttr.ZORIGINALTRANSMISSIONREFERENCE AS 'zEdIPTCAttr-Org Transmission Re',
          ...
          zEditedIPTCAttr.ZSUBJECTREFERENCE AS 'zEdIPTCAttr-Subject Re',
