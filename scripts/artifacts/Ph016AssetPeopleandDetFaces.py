...
__artifacts_v2__ = {
    'Ph016_1PeopleFacesAssetDataPhDaPsql': {
        ...
        'category': 'Photos.sqlite-Assets-PeopleFaces-PhotoData-Psql',
        'notes': '',
    ...
    'Ph016_2PeopleFacesAssetDataSyndPL': {
        ...
        'category': 'Photos.sqlite-Assets-PeopleFaces-SyndicationPL-Psql',
        'notes': '',
...
@artifact_processor
def Ph016_1PeopleFacesAssetDataPhDaPsql(files_found, report_folder, seeker, wrap_text, timezone_offset):
...
@artifact_processor
def Ph016_2PeopleFacesAssetDataSyndPL(files_found, report_folder, seeker, wrap_text, timezone_offset):
    for source_path in files_found:
        source_path = str(source_path)
