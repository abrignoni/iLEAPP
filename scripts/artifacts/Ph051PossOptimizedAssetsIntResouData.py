...
__artifacts_v2__ = {
	'Ph051PossibleOptimizedAssetsIntResouPhDaPsql': {
		...
		'category': 'Photos.sqlite-Assets-OptimizedforStorage-PhotoData-Psql',
		'notes': '',
...
@artifact_processor
def Ph051PossibleOptimizedAssetsIntResouPhDaPsql(files_found, report_folder, seeker, wrap_text, timezone_offset):
