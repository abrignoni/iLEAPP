    ...
    for file_found in files_found:
        if len(files_found) > 1:
            ...
            with open(filetoprocessOne[0], "rb") as fp:
                ...
                for key, val in pl.items():
                    ...
                    if key == 'KeepMessageForDays':
                        data_list.append(('Keep Messages for Days (iOS <=16)',val,file_found))
                        logdevinfo(f"<b>Keep Messages for Days (iOS <=16): </b>{val}")
                        indicator = 1
                        
                    if key == 'SSKeepMessages':
                        data_list.append(('Keep Messages for Days (iOS 17+)',val,file_found))
                        logdevinfo(f"<b>Keep Messages for Days (iOS 17+): </b>{val}")
                        indicator = 1
                        
                if indicator == 0:
                    data_list.append(('Keep Messages for Days','No value',filetoprocessOne[0]))
                    logdevinfo(f"<b>Keep Messages for Days: </b>No Value")
            ...
            with open(filetoprocessTwo[0], "rb") as fp:
                ...
                for key, val in pl.items():
                    if key == 'KeepMessageForDays':
                        ...
                        data_list.append(('Keep Messages for Days (iOS <=16)',keep_val,file_found))
                        logdevinfo(f"<b>Keep Messages for Days (iOS <=16): </b>{keep_val}")
                        indicator = 1
                    ...
                    if key == 'SSKeepMessages':
                        ...
                        data_list.append(('Keep Messages for Days (iOS 17+)',keep_val,file_found))
                        logdevinfo(f"<b>Keep Messages for Days (iOS 17+): </b>{keep_val}")
                        indicator = 1
                        
                if indicator == 0:
                    data_list.append(('Keep Messages for Days','No value',filetoprocessTwo[0]))
                    logdevinfo(f"<b>Keep Messages for Days: </b>No Value")
            break
            ...
            with open(file_found, "rb") as fp:
                ...
                if indicator == 0:
                    data_list.append(('Keep Messages for Days','No value',file_found))
