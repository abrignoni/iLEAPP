...
__artifacts_v2__ = {
    'Ph034iCloudSharedLinkRecordswithNADPhDaPsql': {
        ...
        'category': 'Photos.sqlite-Shared-iCldLinks-NAD-PhotoData-Psql',
        'notes': '',
...
@artifact_processor
def Ph034iCloudSharedLinkRecordswithNADPhDaPsql(files_found, report_folder, seeker, wrap_text, timezone_offset):
