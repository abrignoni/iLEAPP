...
__artifacts_v2__ = {
    'Ph002_1AssetBasicGenAlbumDataPhDaPsql': {
        ...
        'category': 'Photos.sqlite-Assets-BasicData-wAlbums-PhotoData-Psql',
        'notes': '',
        ...
        'sample_data': {
            ...
            'abe_ios16': 'iOS 16.5 | 1922 rows',
            'felix23_ios16': 'iOS 16.5 | 34 rows',
            'hickman_ios13': 'iOS 13.3.1 | 57 rows',
    ...
    'Ph002_2AssetBasicConversationDataSyndPL': {
        ...
        'category': 'Photos.sqlite-Assets-BasicData-wAlbums-SyndicationPL-Psql',
        'notes': '',
    ...
    'Ph002_3AssetBasicGenAlbumGenPlayPsql': {
        ...
        'category': 'Photos.sqlite-Assets-BasicData-wAlbums-GenPlaygrndPL-Psql',
        'notes': '',
...
@artifact_processor
def Ph002_1AssetBasicGenAlbumDataPhDaPsql(files_found, report_folder, seeker, wrap_text, timezone_offset):
...
@artifact_processor
def Ph002_2AssetBasicConversationDataSyndPL(files_found, report_folder, seeker, wrap_text, timezone_offset):
    for source_path in files_found:
        source_path = str(source_path)
...
@artifact_processor
def Ph002_3AssetBasicGenAlbumGenPlayPsql(files_found, report_folder, seeker, wrap_text, timezone_offset):
    for source_path in files_found:
        source_path = str(source_path)
