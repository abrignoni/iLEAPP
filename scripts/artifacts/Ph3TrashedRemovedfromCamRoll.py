...
#   and supports iOS 11-17. SyndPL Parser parses basic asset record data from
#   Syndication.photoslibrary-database-Photos.sqlite for indicators of assets removed from the camera roll
#   and supports iOS 15-17. The results for these scripts will contain one record per ZASSET table Z_PK value.
