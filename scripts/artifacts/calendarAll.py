...
def get_calendar(files_found, report_folder, seeker, wrap_text, timezone_offset):
    ...
    for file_found in files_found:
        ...
        if file_found.endswith('/Calendar.sqlitedb'):
            break
    ...
    SELECT
    CalendarItem.ROWID, 
    datetime(CalendarItem.start_date + 978307200, 'unixepoch') AS 'Start Time',
    datetime(CalendarItem.end_date + 978307200, 'unixepoch') AS 'End Time',
    ...
    datetime(CalendarItem.creation_date + 978307200, 'unixepoch') AS 'Creation Time',
    datetime(CalendarItem.last_modified + 978307200, 'unixepoch') AS 'Last Modification Time'
    FROM CalendarItem
    ...
    if usageentries > 0:
        ...
        description = "Bithdays present in Calendar"
